...
class Setup:
    ...
    def setup(self):
        ...
        self.setup_sliding_panel()
        

    
    def setup_sliding_panel(self):
        from search_tab.sliding_panel import SlidingPanel
        self.music_player.SlidingPanel = SlidingPanel(
            music_player=self.music_player,
            root=self.music_player.root,
            # frame=self.music_player.thumbnail_frame,
            frame=self.music_player.thumbnail_image,
            width=50,
            height=500,
            )
        # from utils.tools import make_frame_transparent
        # make_frame_transparent(self.music_player.thumbnail_frame)
        
        print(f"DEBUG: Sliding panel créé")
        
        # Ajouter un raccourci clavier pour tester le panel
        self.music_player.root.bind('<F12>', lambda e: self.music_player.sliding_panel.force_show_panel())
    ...
    def load_config(self):
        ...
        try:
            ...
            if os.path.exists(self.music_player.config_file):
                ...
                if "thumbnail_offsets" in config:
                    self.music_player.thumbnail_offsets = config["thumbnail_offsets"]
...
def setup_controls(self):
        ...
        # Ordre: recommendation, shuffle, loop, prev, play, next, add, like, favorite
        
        # Boutons plus petits (recommendation, shuffle, loop, add, like, favorite)
        small_button_style = {'width': 30, 'height': 30}
        
        # Bouton Recommandations (à gauche de shuffle)
        ...
        #     cursor='hand2'
        # )
        self.random_button = ctk.CTkButton(button_frame,
                                      image=self.icons["shuffle"],
                                      command=self.toggle_random_mode,
                                      cursor='hand2',
                                      text="",
        ...
        #     cursor='hand2'
        # )
        self.loop_button = ctk.CTkButton(button_frame,
                                      image=self.icons["loop"],
                                      command=self.toggle_loop_mode,
                                      cursor='hand2',
                                      text="",
        ...
        #     width=40,
        #     height=40,
        #     command=self.toggle_like_current_song,
        #     takefocus=0,
        #     cursor='hand2'
        # )
        self.like_button = ctk.CTkButton(button_frame,
                                      image=self.icons["like_empty"],
                                      command=self.toggle_like_current_song,
                                      cursor='hand2',
                                      text="",
        ...
        #     button_frame, 
        #     image=self.icons["favorite_empty"],
        #     bg="#3d3d3d",
        #     fg="white",
        #     activebackground="#4a4a4a",
        #     relief="flat",
        ...
        #     cursor='hand2'
        # )
        self.favorite_button = ctk.CTkButton(button_frame,
                                      image=self.icons["favorite_empty"],
                                      command=self.toggle_favorite_current_song,
                                      cursor='hand2',
                                      text="",
...
def setup_search_tab(self):
    ...
    self.youtube_entry.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(5, 0))
    ...
    self.ai_button = tk.Button(
        buttons_right_frame,
        image=self.icons["activate_ai_small"],
        bg="#4a4a4a",
        fg="white",
        activebackground="#5a5a5a",
        relief="flat",
    ...
    self.playlist_scrollbar = ctk.CTkScrollbar(
        playlist_frame,
    ...
    self.main_playlist_container.bind(
        "<Configure>",
        lambda e: self.main_playlist_canvas.configure(
            scrollregion=self.main_playlist_canvas.bbox("all")
        )
    )
