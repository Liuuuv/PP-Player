...
class MusicPlayer:
    ...
    def setup_search_tab(self):
        ...
        # Bind sur le canvas pour détecter les changements de vue
        def on_canvas_scroll(*args):
            self.youtube_canvas.after_idle(self._check_scroll_position)
        
        self.youtube_canvas.configure(yscrollcommand=lambda *args: (self.scrollbar.set(*args), on_canvas_scroll()))
