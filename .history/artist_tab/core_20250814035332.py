                        ...
                        def update_cached():
                            try:
                                if (hasattr(self, 'root') and self.root and 
                                    hasattr(thumbnail_label, 'winfo_exists') and thumbnail_label.winfo_exists()):
                ...
                if response.status_code == 200:
                    ...
                    def update_thumbnail():
                        try:
                            ...
                            pass  # Widget détruit ou application fermée
        ...
        def load_count():
            try:
                ...
                def update_error():
                    try:
                        if (hasattr(self, 'root') and self.root and 
                            hasattr(count_label, 'winfo_exists') and count_label.winfo_exists()):
                            count_label.config(text="Playlist")
                    except (tk.TclError, AttributeError):
                        pass
