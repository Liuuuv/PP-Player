...
def _display_results_in_batches(self, items, container, item_type, batch_size=2):
        ...
        # Diviser les éléments en lots plus petits pour plus de fluidité
        ...
        def display_batch(batch_index):
            ...
            # Programmer le lot suivant avec un délai plus court pour plus de fluidité
            self.safe_after(25, lambda: display_batch(batch_index + 1))
