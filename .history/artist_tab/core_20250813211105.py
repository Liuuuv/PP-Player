...
def _start_artist_name_animation(self):
    ...
    import tools
    truncated_name = tools._truncate_text_for_display(self, self.current_artist_name, max_width_pixels=180, font_family='TkDefaultFont', font_size=9)
