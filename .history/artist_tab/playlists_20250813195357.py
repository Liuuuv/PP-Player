...
def _display_artist_playlists(self, playlists):
        ...
        artist_tab.core._display_results_in_batches(self, playlists, scrollable_frame, "playlists")
...
def _display_playlist_content(self, videos, playlist_title, target_tab="sorties"):
    ...
    import artist_tab.core
    artist_tab.core._display_results_in_batches(self, videos, scrollable_frame, "videos")
