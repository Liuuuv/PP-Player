    ...
    def load_playlist_content():
        try:
            ...
            if playlist_url in self.playlist_content_cache:
                ...
                self.root.after(0, lambda: _display_playlist_content(cached_videos, playlist_title, target_tab))
                return
            ...
            if 'watch?v=' in playlist_url and 'list=' not in playlist_url:
                ...
                self.root.after(0, lambda: _display_playlist_content([video_data], playlist_title, target_tab))
                return
            ...
            with YoutubeDL(playlist_opts) as ydl:
                ...
                if playlist_info and 'entries' in playlist_info:
                    ...
                    playlist_title = playlist_data.get('title', 'Playlist')
                    self.root.after(0, lambda: _display_playlist_content(videos, playlist_title, target_tab))
                elif playlist_info:
