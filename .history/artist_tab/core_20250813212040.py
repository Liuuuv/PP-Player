...
def _add_artist_result(self, video, index, container):
        ...
        try:
            ...
            def on_result_right_click(event, frame=result_frame):
                # Clic droit pour le menu contextuel de sélection multiple
                if self.selected_items:
                    # Afficher le menu de sélection multiple
                    import tools
            ...
            for widget in all_widgets:
                ...
                widget.bind("<Button-3>", lambda e, f=result_frame: self._handle_right_click(e, f))
...
def _start_artist_name_animation(self):
    ...
    import tools
    truncated_name = tools._truncate_text_for_display(self, self.current_artist_name, max_width_pixels=90, font_family='TkDefaultFont', font_size=9)
...
def _handle_right_click(self, event, frame):
    ...
    if self.selected_items:
        ...
        self._on_result_right_click(event, frame)