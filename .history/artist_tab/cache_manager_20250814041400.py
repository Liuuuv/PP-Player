...
class ArtistCacheManager:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.max_artists = 15  # Spécifique aux artistes
        ...
        self.cache_file = os.path.join("downloads", "search_cache.json")
    ...
    def should_preload_search(self, search_query):
        ...
        if search_query in self.search_usage_stats:
            ...
            # Précharger si utilisée plus de 2 fois et récemment
            return (stats['count'] >= 2 and 
                    time.time() - stats['last_used'] < 86400)  # 24h
        return False
    
    def get_searches_to_preload(self, limit=5):
    ...
    def save_cache_to_disk(self):
        ...
        try:
            ...
            cache_data = {
                ...
                'search_timestamps': self.search_timestamps,
                'interface_state_cache': self.interface_state_cache,
                'search_usage_stats': self.search_usage_stats,
                'version': '1.1',
                'saved_at': time.time()
            }
            ...
            print(f"DEBUG: Cache sauvegardé sur disque ({len(self.search_cache)} recherches)")
    ...
    def load_cache_from_disk(self):
        ...
        try:
            ...
            if version not in ['1.0', '1.1']:
                print("DEBUG: Version de cache incompatible, ignoré")
                return
            ...
            print(f"DEBUG: Cache chargé depuis le disque ({len(self.search_cache)} recherches)")
