...
def _reset_playlist_content_state(self, tab_name=None):
    ...
    try:
        print(f"DEBUG: _reset_playlist_content_state appelée avec tab_name='{tab_name}'")
        print(f"DEBUG: Avant - artist_tab_active_sorties={self.artist_tab_active_sorties}, artist_tab_active_playlists={self.artist_tab_active_playlists}")
        ...
        print(f"DEBUG: Après - artist_tab_active_sorties={self.artist_tab_active_sorties}, artist_tab_active_playlists={self.artist_tab_active_playlists}")
