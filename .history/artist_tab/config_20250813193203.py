...
# Options YouTube-DL pour les recherches d'artiste
...
ARTIST_SEARCH_LIMITS = {
    ...
    'max_releases': 30,
    'max_playlists': 20,
    'batch_size': 3,  # Nombre d'éléments à afficher par lot
    'display_delay': 50  # Délai en ms entre chaque lot
}
...
ARTIST_THUMBNAILS = {
    ...
    'timeout': 10,  # Timeout en secondes pour le chargement
    'retry_count': 3
}
