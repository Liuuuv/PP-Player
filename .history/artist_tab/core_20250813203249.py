...
def _start_parallel_searches(self):
        ...
        try:
            ...
            self.safe_after(300, lambda: self._start_releases_search())
            
            # Lancer les playlists après un délai plus long
            self.safe_after(600, lambda: self._start_playlists_search())
...
def _on_channel_id_found(self, channel_id):
    ...
    self.safe_after(25, lambda: _start_parallel_searches(self))
