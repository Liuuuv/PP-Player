...
def _search_artist_releases_with_id(self):
        ...
        try:
            ...
            if cache_key in self.artist_cache and 'releases' in self.artist_cache[cache_key]:
                ...
                self.root.after(0, lambda: _display_artist_releases(self, cached_releases))
                return
                
            # Options ultra-optimisées pour extraire les releases de la chaîne rapidement
            search_opts = {
                'extract_flat': True,
                'quiet': True,
                'no_warnings': True,
                ...
                'playlistend': 15,      # Limiter à 15 releases pour plus de rapidité
            ...
            with YoutubeDL(search_opts) as ydl:
                ...
                for i, playlist in enumerate(all_playlists):
                    ...
                    if i % 3 == 0 and self.artist_search_cancelled:
                        return
...
def _display_artist_releases(self, releases):
        ...
        core._reset_playlist_content_state(self, "sorties")
        ...
        def _on_mousewheel(event):
            ...
            core._check_scroll_bottom(self, canvas, "releases")
        ...
        self.sorties_frame.bind("<MouseWheel>", _on_mousewheel)
        ...
        self.artist_releases_canvas = canvas
...
def _return_to_releases(self):
        ...
        self.artist_releases_thread = threading.Thread(target=lambda: _search_artist_releases_with_id(self), daemon=True)
        self.artist_releases_thread.start()
