...
def _add_artist_playlist_result(self, playlist, index, container, target_tab="sorties"):
        ...
        try:
            ...
            from . import utils
            display_title = utils.truncate_text_for_display(self, title, max_width_pixels=ARTIST_TAB_MAX_WIDTH_ARTIST_NAME, font_size=8)
...
def _start_artist_name_animation(self):
    ...
    import tools
    truncated_name = tools._truncate_text_for_display(self, self.current_artist_name, max_width_pixels=ARTIST_TAB_MAX_WIDTH_ARTIST_NAME, font_family='TkDefaultFont', font_size=9)
