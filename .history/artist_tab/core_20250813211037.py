...
def _create_artist_tabs(self):
        ...
        # Positionner le label au centre, à la même hauteur que les onglets
        self.artist_name_label.place(relx=0.5, y=12, anchor='center')
...
def _add_artist_result(self, video, index, container):
        ...
        try:
            ...
            import config
            if duration > config.MAX_DURATION_SHOW_SEARCH:
