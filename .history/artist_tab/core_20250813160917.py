...
def _reset_playlist_content_state(self):
    ...
    try:
        ...
        if hasattr(self, 'playlist_back_btn_sorties') and self.playlist_back_btn_sorties:
            try:
                self.playlist_back_btn_sorties.place_forget()
            except:
                pass
        
        if hasattr(self, 'playlist_back_btn_playlists') and self.playlist_back_btn_playlists:
            try:
