...
def _search_artist_playlists_with_id(self):
        ...
        try:
            ...
            # Options ultra-optimisées pour extraire les playlists de la chaîne rapidement
            search_opts = {
                'extract_flat': True,
                'quiet': True,
                'no_warnings': True,
                ...
                'playlistend': 10,      # Limiter à 10 playlists pour plus de rapidité
...
def _display_artist_playlists(self, playlists):
        ...
        def _on_mousewheel(event):
            ...
            core._check_scroll_bottom(self, canvas, "playlists")
        ...
        self.playlists_frame.bind("<MouseWheel>", _on_mousewheel)
        ...
        self.artist_playlists_canvas = canvas
...
def _display_playlist_content(self, videos, playlist_title, target_tab="sorties"):
    ...
    back_command = self.artist_tab_manager.smart_back_action
...
def _show_playlist_content(self, playlist_data, target_tab="sorties"):
    ...
    def load_playlist_content():
        try:
            ...
            if not playlist_url:
                self.root.after(0, lambda: _show_playlist_error(self, "URL de playlist non trouvée"))
                return
