...
def _start_parallel_searches(self):
        ...
        try:
            ...
            self.artist_videos_thread = threading.Thread(target=lambda: artist_tab.songs._search_artist_videos_with_id(self), daemon=True)
            self.artist_releases_thread = threading.Thread(target=lambda: artist_tab.releases._search_artist_releases_with_id(self), daemon=True)
            self.artist_playlists_thread = threading.Thread(target=lambda: artist_tab.playlists._search_artist_playlists_with_id(self), daemon=True)
