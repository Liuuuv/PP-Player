...
def _search_artist_videos_with_id(self):
        ...
        try:
            ...
            # Configuration optimisée pour extraire les vidéos de la chaîne rapidement
            search_opts = {
                'extract_flat': True,  # Plus efficace et contient la durée
                'quiet': True,
                'no_warnings': True,
                'ignoreerrors': True,
                'socket_timeout': 5,    # Timeout court
                'retries': 1,           # Moins de tentatives
                'fragment_retries': 1,  # Moins de tentatives pour les fragments
                'playlistend': 25       # Limiter à 25 vidéos pour plus de rapidité
            }
