...
def _create_artist_tabs(self):
        ...
        # Créer un frame pour le header (nom de l'artiste + notebook)
        header_frame = tk.Frame(main_container, bg='#3d3d3d')
        header_frame.pack(fill=tk.X, padx=(0, 30))  # Laisser de la place pour le bouton croix
        
        # Créer le label pour le nom de l'artiste avec animation
        ...
        self.artist_name_label.pack(side=tk.TOP, fill=tk.X, pady=(5, 10))
...
def _start_artist_name_animation(self):
    ...
    import tools
    truncated_name = tools._truncate_text_for_display(self, self.current_artist_name, max_width_pixels=300, font_family='TkDefaultFont', font_size=11)
