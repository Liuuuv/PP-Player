...
def setup_search_tab(self):
    ...
    self._bind_mousewheel(self.playlist_canvas, self.playlist_canvas, func=self.search_tab.main_playlist.forward_wheel)
    self._bind_mousewheel(self.playlist_container, self.playlist_canvas, func=self.search_tab.main_playlist.forward_wheel)
