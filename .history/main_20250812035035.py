...
class MusicPlayer:
    ...
    def add_selection_to_queue_first(self):
        ...
        tools.add_selection_to_queue_first(self)
    ...
    def add_selection_to_playlist(self, playlist_name):
        ...
        tools.add_selection_to_playlist(self, playlist_name)
    ...
    def _save_current_search_state(self):
        ...
        return self._save_current_search_state(self)
            ...
            try:
                ...
                with YoutubeDL(search_opts) as ydl:
                    ...
                    if hasattr(self, 'current_artist_channel_url') and self.current_artist_channel_url:
                        try:
                            # Construire l'URL de l'onglet vidéos
                            if '/channel/' in self.current_artist_channel_url:
                                videos_url = self.current_artist_channel_url + '/videos'
                            elif '/@' in self.current_artist_channel_url:
                                videos_url = self.current_artist_channel_url + '/videos'
                            else:
                                videos_url = self.current_artist_channel_url
                            
                            # Extraire les vidéos de la chaîne
                            ...
                            print(f"Erreur extraction chaîne: {e}")
        ...
        def load_playlist_content():
            try:
                ...
                with YoutubeDL(playlist_opts) as ydl:
                    ...
                    print("DEBUG", playlist_info) # debug
