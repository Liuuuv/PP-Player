...
def setup_controls(self):
        ...
        # Bouton de copie de la status bar (même style que output.png avec icône stats.png)
        ...
        # Positionner le bouton comme output.png mais à gauche (avant stats.png)
        self.copy_status_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-105, y=-5)
