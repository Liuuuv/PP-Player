...
class MusicPlayer:
    ...
    def create_ui(self):
        ...
        style.configure('ErrorDownloading.TFrame', background="#a20000")  # Style rouge pour téléchargement
        ...
        try:
            ...
            for ext in ['.jpg', '.png', '.webp']:
                ...
                if os.path.exists(thumbnail_path):
                    print(thumbnail_path,label,"uwu")
        ...
        try:
            ...
            if not os.path.exists(downloads_dir):
                try:
                    ...
                    self.status_bar.config(text=f"Erreur création dossier: {str(e)}")
                    return
            ...
            with YoutubeDL(ydl_opts) as ydl:
                ...
                video['frame'].configure(style='ErrorDownloading.TFrame')
