...
INITIAL_DISPLAY_BATCH_SIZE = 10  # nombre d'éléments à afficher initialement
...
## CA DOIT ETRE DES COULEURS DIFFERENTES :')
...
DOWNLOADS_TITLE_MAX_WIDTH = 200
DOWNLOADS_TITLE_ANIMATION_STARTUP = 5
DOWNLOADS_TITLE_ANIMATION_PAUSE = 30

DOWNLOADS_ARTIST_MAX_WIDTH = 200
DOWNLOADS_ARTIST_ANIMATION_STARTUP = 5
DOWNLOADS_ARTIST_ANIMATION_PAUSE = 30
...
MAIN_PLAYLIST_ARTIST_MAX_WIDTH = 170
MAIN_PLAYLIST_ARTIST_ANIMATION_STARTUP = 5
MAIN_PLAYLIST_ARTIST_ANIMATION_PAUSE = 30

COLOR_WINDOW_BACKGROUND = '#2d2d2d'



PLAYLIST_CARD_NAME_FONT = ('TkDefaultFont', 11, 'bold')
PLAYLIST_CARD_NB_TITLES_FONT = ('TkDefaultFont', 9)

PLAYLIST_CARD_NAME_MAX_WIDTH = 100
PLAYLIST_CARD_NAME_ANIMATION_STARTUP = 5
PLAYLIST_CARD_NAME_ANIMATION_PAUSE = 30

MAIN_PLAYLIST_REST_TIMER_AFTER_LOADING = 500

# Configuration du chargement paresseux pour l'onglet téléchargements
DOWNLOADS_INITIAL_LOAD_COUNT = 20  # Nombre de téléchargements à charger initialement
DOWNLOADS_SCROLL_LOAD_COUNT = 10   # Nombre de téléchargements à charger/décharger lors du scroll