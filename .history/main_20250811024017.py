...
class MusicPlayer:
    ...
    def update_time(self):
        while True:
            # Vérifier si pygame mixer est initialisé avant d'utiliser ses fonctions
            if pygame.mixer.get_init() and pygame.mixer.music.get_busy() and not self.paused and not self.user_dragging:
