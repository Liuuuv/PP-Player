...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        self.artist_notebook.pack(side=tk.TOP, fill=tk.BOTH, expand=True, padx=5, pady=5, before=self.saved_search_state['results_children'][0] if self.saved_search_state['results_children'] else None)
    ...
    def _return_to_search(self):
        ...
        try:
            ...
            # Vider les résultats actuels et cacher la zone YouTube
            self._clear_results()
