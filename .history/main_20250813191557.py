...
class MusicPlayer:
    def __init__(self, root):
        ...
        # self.current_artist_tab = None  # Onglet où du contenu de playlist est affiché ("Sorties" ou "Playlists")
        ...
        # self.playlist_content_active_playlists = False  # True si du contenu de playlist est affiché dans un tab
    ...
    def on_artist_tab_changed(self, event):
        ...
        try:
            ...
            if current_tab_id:
                ...
                print(f"DEBUG: Changement d'onglet vers: {current_tab_text}")
                ...
                if current_tab_text == "Sorties":
                    ...
                    self.current_artist_tab = "Sorties" if self.artist_tab_active_sorties else None
                elif current_tab_text == "Playlists":
                    self.playlist_content_active = self.artist_tab_active_playlists
                    self.current_artist_tab = "Playlists" if self.artist_tab_active_playlists else None
    ...
    def _update_back_button_visibility(self, current_tab_text):
        ...
        try:
            ...
            should_show = False
            if current_tab_text == "Sorties" and self.artist_tab_active_sorties:
                should_show = True
            elif current_tab_text == "Playlists" and self.artist_tab_active_playlists:
                should_show = True
            
            print(f"DEBUG: Tab={current_tab_text}, Sorties={self.artist_tab_active_sorties}, Playlists={self.artist_tab_active_playlists}, Should show={should_show}")
    ...
    def _reset_playlist_content_state(self, tab_name=None):
        ...
        print(f"_reset_playlist_content_state: {tab_name}")
    ...
    def _show_playlist_content(self, playlist_data, target_tab="sorties"):
        ...
        return artist_tab.playlists._show_playlist_content(self, playlist_data, target_tab)
    ...
    def _display_playlist_content(self, videos, playlist_title, target_tab="sorties"):
        ...
        return artist_tab.playlists._display_playlist_content(self, videos, playlist_title, target_tab)
