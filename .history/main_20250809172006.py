    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            def update_truncated_text():
                ...
                available_width = text_frame.winfo_width() - 10  # Marge de 10px
                
                if available_width > 50:  # Largeur minimale raisonnable
            ...
            self.root.after(10, update_truncated_text)
            
            # Lier l'événement de redimensionnement pour mettre à jour la troncature
            text_frame.bind('<Configure>', lambda e: update_truncated_text())
