...
class CustomProgressSlider(tk.Frame):
    ...
    def draw_slider(self, force_redraw=False):
        ...
        try:
            ...
            if self.dragging:
                print(f"[DEBUG] draw_slider - DRAGGING MODE")
                print(f"  current_value: {self.current_value}")
                print(f"  last_drawn_value: {self.last_drawn_value}")
                print(f"  current_drag_x: {current_drag_x}")
                print(f"  last_drawn_drag_x: {self.last_drawn_drag_x}")
                print(f"  force_redraw: {force_redraw}")
            ...
            if not force_redraw:
                if self.dragging:
                    ...
                    print(f"  drag_position_changed: {drag_position_changed}")
