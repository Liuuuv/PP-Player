...
class MusicPlayer:
    ...
    def change_output_device(self, selected_device, device_name):
        ...
        try:
            ...
            # S'assurer que le périphérique est en bytes pour pygame
            device_bytes = selected_device if isinstance(selected_device, bytes) else selected_device.encode('utf-8')
            pygame.mixer.init(devicename=device_bytes, frequency=44100, size=-16, channels=2, buffer=4096)
