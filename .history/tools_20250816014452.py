...
def _add_song_item(self, filepath_or_video, container, playlist_name=None, song_index=None, item_type="downloads", video_index=None):
    ...
    try:
        ...
        metadata_frame.columnconfigure(0, weight=1)  # Artiste
        metadata_frame.columnconfigure(1, weight=0)  # Album
        metadata_frame.columnconfigure(2, weight=0)  # Date
        ...
        date_label.grid(row=0, column=2, sticky='w', padx=(5, 0))
                    ...
                    if label.cget('text') == "⏵":  # C'est le label de miniature
                        ...
                        #         label.config(text="• " + other_metadata_text)
                            ...
                            if album:
                                ...
                                print("DEBUG: LOAD_NEXT_THUMBNAIL ALBUM", album)
                                # other_parts.append(album)
