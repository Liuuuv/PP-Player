    ...
    def _get_audio_duration(self, filepath):
        ...
        try:
            if filepath.lower().endswith('.mp3'):
                ...
                File "c:\Users\olivi\kDrive\projets\loisir\music_player\main.py", line 3662, in _apply_volume
    return tools._apply_volume(self)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "c:\Users\olivi\kDrive\projets\loisir\music_player\tools.py", line 75, in _apply_volume
...
pygame.error: mixer not initialized
    ...
    def show_output_menu(self):
        ...
        try:
            ...
            # Créer une variable partagée pour les radiobuttons
