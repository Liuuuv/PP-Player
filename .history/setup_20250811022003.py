...
def create_ui(self):
    ...
    # Bouton Output à la même hauteur que les onglets, tout à droite
    ...
    # Positionner le bouton à la même hauteur que les onglets
    self.output_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-5, y=2)
