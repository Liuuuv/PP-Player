...
class MusicPlayer:
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            # Si en cours de téléchargement, appliquer un style différent
            if downloading:
                item_frame.configure(style='Downloading.TFrame')
                for child in item_frame.winfo_children():
                    if isinstance(child, (tk.Label, tk.Frame, tk.Button)):
                        child.config(bg='#ff4444')
            ...
            # Gestion du double-clic pour jouer la musique
