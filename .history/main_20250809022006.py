...
class MusicPlayer:
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            # Miniature
            thumbnail_label = tk.Label(canvas, bg='#3d3d3d', width=10, height=10)
            canvas.create_window(2, 25, anchor='w', window=thumbnail_label)
            ...
            def adjust_text():
                max_width = text_frame.winfo_width() + 15  # Marge pour le bouton
