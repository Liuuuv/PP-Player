...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        # Créer un frame container avec notebook et croix sur la même ligne
        container_frame = tk.Frame(self.youtube_results_frame, bg='#3d3d3d')
        container_frame.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)
        
        # Créer le notebook
        self.artist_notebook = ttk.Notebook(container_frame, takefocus=0)
        self.artist_notebook.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)
        
        # Ajouter le bouton croix à droite du notebook, aligné avec les onglets
        ...
        # Positionner la croix à droite, alignée avec les onglets sans s'étendre
        close_btn.pack(side=tk.RIGHT, padx=(5, 0), pady=(2, 0), fill=None, expand=False)
                    ...
                    if hasattr(self, 'current_artist_channel_url') and self.current_artist_channel_url:
                        ...
                        try:
                            if '%' in base_url:
                                ...
                                print(f"URL décodée: {base_url} -> {decoded_url}")
                        ...
                        # Construire l'URL de l'onglet vidéos (triées par date de sortie)
                        channel_urls_to_try = []
