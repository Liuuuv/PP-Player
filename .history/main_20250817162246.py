        ...
        while True:
            try:
                ...
                if pygame.mixer.music.get_busy() and not self.paused and not self.user_dragging:
                    ...
                    # Debug temporaire - décommentez la ligne suivante pour voir les valeurs
                    # print(f"DEBUG: base_position={self.base_position}, pygame_pos={pygame_pos}, current_time={self.current_time}", flush=True)
