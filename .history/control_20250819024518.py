...
def next_track(self):
    ...
    try:
        ...
        print(f"DEBUG: Méthodes disponibles - is_index_loaded: {has_is_index_loaded}, progressive_load: {has_progressive_load}, append_items: {has_append_items}")
        ...
        if has_is_index_loaded:
            ...
            if hasattr(self, '_just_used_find_button'):
                ...
                print("DEBUG: Flag _just_used_find_button activé (changement de musique)")
