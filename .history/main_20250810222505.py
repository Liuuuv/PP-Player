...
class MusicPlayer:
    ...
    def _truncate_text_for_display(self, text, max_width_pixels=200, max_lines=1):
        """Tronque le texte pour l'affichage avec des '...' si nécessaire"""
        return tools._truncate_text_for_display(self, text, max_width_pixels, max_lines)
    ...
    def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            truncated_title = self._truncate_text_for_display(filename, max_width_pixels=170)
            title_label = tk.Label(
                item_frame,
