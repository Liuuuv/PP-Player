...
def test_add_to_main_playlist():
    ...
    # Test 6: Ajouter un doublon avec allow_duplicates=True
    print("\n6. Test ajout d'un doublon avec allow_duplicates=True:")
    result = player.add_to_main_playlist("test_song1.mp3", allow_duplicates=True)
    print(f"   Résultat: {result}")
    print(f"   Playlist: {player.main_playlist}")
    
    # Test 7: Ajouter encore un doublon avec allow_duplicates=True et show_status=False
    print("\n7. Test ajout d'un doublon avec allow_duplicates=True et show_status=False:")
    result = player.add_to_main_playlist("test_song2.mp3", allow_duplicates=True, show_status=False)
    print(f"   Résultat: {result}")
    print(f"   Playlist: {player.main_playlist}")
