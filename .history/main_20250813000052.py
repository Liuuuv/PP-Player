...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        # Créer un frame pour la zone des onglets avec la croix
        tabs_header_frame = tk.Frame(main_container, bg='#3d3d3d', height=30)
        tabs_header_frame.pack(fill=tk.X, pady=(0, 2))
        tabs_header_frame.pack_propagate(False)  # Maintenir la hauteur fixe
        
        # Ajouter le bouton croix dans le coin supérieur droit
        ...
        # Créer le notebook dans le container principal
