...
class MusicPlayer:
    ...
    def _clear_main_playlist(self, event=None):
        ...
        # Arrêter complètement la lecture et unloader la musique
        pygame.mixer.music.stop()
        pygame.mixer.music.unload()  # Unloader complètement la musique
        self.paused = False  # Réinitialiser l'état de pause
        ...
        # Enlever la miniature sur l'onglet search
        if hasattr(self, 'thumbnail_frame') and self.thumbnail_frame.winfo_exists():
            # Nettoyer le contenu de la frame thumbnail
            for widget in self.thumbnail_frame.winfo_children():
                widget.destroy()
            
            # Afficher une icône musicale par défaut (identique au démarrage)
            ...
            # Pack à gauche sans padding pour coller au bord (comme au démarrage)
        ...
        # Mettre à jour les highlights dans les téléchargements (enlever COLOR_SELECTED)
    ...
    def add_to_main_playlist(self, filepath, thumbnail_path=None, song_index=None, show_status=True, allow_duplicates=False):
        ...
        """
        print("Ajout de la musique à la playlist principale")
