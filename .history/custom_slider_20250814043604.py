...
class CustomVolumeSlider(tk.Frame):
    ...
    def __init__(self, parent, from_=0, to=100, value=50, command=None, orient='horizontal', 
        ...
        # Ne pas intercepter les événements de scroll - les laisser passer
        self.bind('<MouseWheel>', lambda e: None)
        self.bind('<Button-4>', lambda e: None)  # Linux
        self.bind('<Button-5>', lambda e: None)  # Linux
        self.canvas.bind('<MouseWheel>', lambda e: None)
        self.canvas.bind('<Button-4>', lambda e: None)  # Linux
        self.canvas.bind('<Button-5>', lambda e: None)  # Linux
