...
class MusicPlayer:
    ...
    def select_library_item_from_filepath(self, current_filepath):
        ...
        return tools.select_song_item_from_filepath(self, current_filepath, self.library_content_frame)
    ...
    def select_playlist_content_item_from_filepath(self, current_filepath):
        ...
        return tools.select_song_item_from_filepath(self, current_filepath, self.playlist_container)
