...
class MusicPlayer:
    def __init__(self, root):
        ...
        self.play_queue = []  # Liste ordonnée des musiques en queue (à jouer après la chanson actuelle)
    ...
    def play_all_downloads_ordered(self):
        ...
        # Marquer que la main playlist provient des téléchargées (active les numéros)
        self.main_playlist_from_playlist = True
    ...
    def add_to_playlist(self):
        ...
        # PRÉSERVATION DES NUMÉROS : Garder la numérotation si elle était active
        # Ne pas désactiver automatiquement lors d'ajouts manuels
    ...
    def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            # INDICATEUR DE QUEUE : Vérifier si dans la queue pour changer l'apparence
            is_in_queue = hasattr(self, 'play_queue') and filepath in self.play_queue
            
            # 1. Frame principal - grand rectangle uniforme avec indication de queue
            if is_in_queue:
                # Bordure épaisse foncée à gauche pour indiquer la queue
                item_frame = tk.Frame(
                    self.playlist_container,
                    bg='#4a4a4a',  # Fond gris uniforme
                    relief='solid',
                    bd=0,
                    highlightbackground='#1a1a1a',  # Bordure très foncée pour la queue
