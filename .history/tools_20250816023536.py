...
def _add_song_item(self, filepath_or_video, container, playlist_name=None, song_index=None, item_type="downloads", video_index=None):
    ...
    try:
        ...
        artist_label.pause_counter = 15  # Compteur pour la pause entre les cycles
        ...
        album_label.pause_counter = 15  # Compteur pour la pause entre les cycles
