...
class MusicPlayer:
    ...
    def play_track(self):
        try:
            ...
            # Démarrer l'animation du titre (ou afficher normalement si pas tronqué)
    ...
    def _download_and_add_to_playlist_thread(self, video, frame, playlist_name):
        ...
        try:
            ...
            with YoutubeDL(ydl_opts) as ydl:
                ...
                # Sauvegarder l'URL YouTube originale
                self.save_youtube_url_metadata(final_path, url)
