    ...
    try:
        ...
        for playlist_name, songs in playlists.items():
            ...
            for song_path in songs:
                ...
                # Vérifier si le chemin commence par l'ancien dossier de téléchargements
                if normalized_song_path.startswith(old_downloads_folder):
                    ...
                    if os.path.exists(new_song_path):
                        ...
                        print(f"Chemin mis à jour: {song_path} -> {new_song_path}")
                    else:
