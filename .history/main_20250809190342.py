...
class MusicPlayer:
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            title_label = tk.Label(
                item_frame,
                text=filename[:-4] if filename.lower().endswith('.mp3') else filename,
                bg='#4a4a4a',
                fg='white',
                font=('TkDefaultFont', 9),
                anchor='w',
...
With these changes, the `_add_download_item` function should now correctly display the downloaded items with the intended styling, resolving the "unknown option -bg" error.
<!--
[PROMPT_SUGGESTION]How can I implement drag and drop functionality for playlist items to reorder them?[/PROMPT_SUGGESTION]
[PROMPT_SUGGESTION]Can you help me add a context menu to the playlist items with options like "Play", "Remove", and "Show File in Explorer"?[/PROMPT_SUGGESTION]
-->
