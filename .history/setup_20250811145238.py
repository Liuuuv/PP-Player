...
def create_ui(self):
    ...
    self.stats_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-30, y=-5)
...
def setup_controls(self):
        ...
        left_spacer_frame.grid(row=0, column=0, sticky="w")
