...
def show_settings_menu(self):
    ...
    try:
        ...
        # Ajouter un titre
        stats_menu.add_command(label="Settings", state='disabled')
        stats_menu.add_separator()
...
def _show_result_context_menu(self, item, event=None, item_type="file"):
...
def show_file_context_menu(self, filepath, event=None):
    ...
    # Rediriger vers le menu unifié
    self._show_result_context_menu(filepath, event, item_type="file")
