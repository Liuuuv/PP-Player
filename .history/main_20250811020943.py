...
class MusicPlayer:
    ...
    def show_output_devices(self):
        ...
        try:
            ...
            device_window.title("Choisir le périphérique de sortie")
            device_window.geometry("400x300")
            device_window.configure(bg='#2d2d2d')
            ...
            instruction_label = tk.Label(
                device_window, 
                text="Sélectionnez un périphérique de sortie audio :",
                bg='#2d2d2d', 
                fg='white',
                font=('Arial', 10)
            )
            ...
            # Frame pour la liste
            list_frame = tk.Frame(device_window, bg='#2d2d2d')
            ...
            # Frame pour les boutons
            button_frame = tk.Frame(device_window, bg='#2d2d2d')
