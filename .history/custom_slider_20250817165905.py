...
class CustomProgressSlider(tk.Frame):
    ...
    def __init__(self, parent, from_=0, to=100, value=0, command=None, orient='horizontal', 
                 length=400, on_progress_press=self.on_progress_press, on_progress_drag=self.on_progress_drag, on_progress_release=self.on_progress_release, **kwargs):
        super().__init__(parent, **kwargs)
    ...
    def draw_slider(self):
        ...
        try:
            ...
            if self.dragging and hasattr(self, 'drag_thumb_x'):
                ...
                print("ON TEST ", thumb_x, self.current_value, track_width)
                # thumb_x = track_start_x + self.current_value * track_width
            ...
            # Dessiner le thumb
            print("DRAWING THUMB AT", thumb_x)
            self.canvas.create_oval(
                thumb_x - self.thumb_radius, track_y - self.thumb_radius,
                thumb_x + self.thumb_radius, track_y + self.thumb_radius,
                fill=thumb_color, outline='#333333', width=1
    ...
    def config(self, **kwargs):
        ...
        if 'value' in kwargs:
            ...
            if hasattr(self, 'song_length') and self.song_length > 0:
                ...
                print("CONFIG CALLED ", value_seconds, self.song_length)
