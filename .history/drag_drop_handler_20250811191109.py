...
class DragDropHandler:
    ...
    def _add_dragged_item_to_playlist(self, frame):
        ...
        try:
            ...
            elif frame.drag_item_type == "main_playlist_item":
                # Élément de la main playlist
                self._add_main_playlist_item_to_queue(frame.drag_file_path)
    ...
    def _add_to_queue_first_dragged_item(self, frame):
        ...
        try:
            if frame.drag_item_type == "file":
                ...
                # Élément de la main playlist
                self._add_main_playlist_item_to_queue_first(frame.drag_file_path)
