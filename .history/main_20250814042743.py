...
class MusicPlayer:
    ...
    def _enable_scroll_propagation(self, widget):
        ...
        def pass_through_scroll(event):
            # Ne rien faire, laisser l'événement se propager naturellement
            pass
        
        # Bind les événements de scroll pour qu'ils ne soient pas interceptés
        widget.bind("<MouseWheel>", pass_through_scroll)
        widget.bind("<Button-4>", pass_through_scroll)  # Linux
        widget.bind("<Button-5>", pass_through_scroll)  # Linux
