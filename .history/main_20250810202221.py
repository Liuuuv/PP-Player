...
class MusicPlayer:
    ...
    def play_selected(self, event):
        return search_tab.control.play_selected(self, event)
    
    def prev_track(self):
        search_tab.control.prev_track(self)

    def next_track(self):
        return search_tab.control.next_track(self)
    
    def show_waveform_on_clicked(self):
        return search_tab.control.show_waveform_on_clicked(self)

    def draw_waveform_around(self, time_sec, window_sec=5):
        return search_tab.control.draw_waveform_around(self, time_sec, window_sec)
    ...
    def on_progress_press(self, event):
        return search_tab.control.on_progress_press(self, event)
    
    def on_progress_drag(self, event):
        return search_tab.control.on_progress_drag(self, event)

    def on_progress_release(self, event):
        return search_tab.control.on_progress_release(self, event)
    
    def on_waveform_canvas_resize(self, event):
        return search_tab.control.on_waveform_canvas_resize(self, event)
    ...
    def set_position(self, val):
        return search_tab.control.set_position(self, val)
