...
class MusicPlayer:
    ...
    def _add_playlist_song_item(self, container, filepath, playlist_name):
        ...
        try:
            ...
            item_frame.columnconfigure(0, minsize=100, weight=0)  # Miniature plus grande
            ...
            thumbnail_label.grid(row=0, column=0, sticky='nsew', padx=(3, 5), pady=3)
            ...
            # 2. Texte
            truncated_title = self._truncate_text_for_display(filename, max_chars_per_line=30, max_lines=2)
            ...
            title_label.grid(row=0, column=1, sticky='nsew', padx=(0, 5), pady=3)
            ...
            buttons_frame.grid(row=0, column=3, sticky='ns', padx=(0, 3), pady=3)
    ...
    def _add_playlist_song_item(self, filepath, playlist_name, song_index):
        ...
        try:
            ...
            item_frame.columnconfigure(1, minsize=100, weight=0)  # Miniature plus grande
            ...
            number_label.grid(row=0, column=0, sticky='nsew', padx=(5, 3), pady=3)
            ...
            thumbnail_label.grid(row=0, column=1, sticky='nsew', padx=(3, 5), pady=3)
            thumbnail_label.grid_propagate(False)
            ...
            title_label.grid(row=0, column=2, sticky='nsew', padx=(0, 5), pady=3)
    ...
    def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            title_label.grid(row=0, column=1+col_offset, sticky='nsew', padx=(0, 5), pady=3)
            ...
            duration_label.grid(row=0, column=2+col_offset, sticky='ns', padx=(0, 5), pady=3)
    ...
    def _load_image_thumbnail(self, image_path, label):
        ...
        try:
            ...
            img.thumbnail((100, 60), Image.Resampling.LANCZOS)  # Plus grande miniature
            ...
            default_icon = Image.new('RGB', (100, 60), color='#3d3d3d')  # Plus grande par défaut
