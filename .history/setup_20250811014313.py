...
def setup_controls(self):
        ...
        # Frame pour les repères temporels (aux extrémités)
        time_frame = ttk.Frame(control_frame)
        time_frame.pack(fill=tk.X, pady=(5, 0))
        
        # Time Label à gauche (temps actuel)
        self.current_time_label = ttk.Label(time_frame, text="00:00")
        self.current_time_label.pack(side=tk.LEFT)
        
        # Time Label à droite (durée totale)
        ...
        # Time Label à droite (au-dessus du volume)
        self.song_length_label = ttk.Label(volume_frame, text="00:00")
        self.song_length_label.pack(pady=(0, 5))
