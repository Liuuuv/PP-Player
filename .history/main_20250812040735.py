...
class MusicPlayer:
    ...
    def _add_search_result(self, video, index):
        ...
        try:
            ...
            duration_label.bind("<Button-3>", lambda e, f=result_frame: self._on_result_right_click(e, f))
            text_frame.bind("<Button-3>", lambda e, f=result_frame: self._on_result_right_click(e, f))
            title_label.bind("<Button-3>", lambda e, f=result_frame: self._on_result_right_click(e, f))
            if metadata_label is not None:  # Ajouter binding pour metadata_frame s'il existe
                metadata_label.bind("<Button-3>", lambda e, f=result_frame: self._on_result_right_click(e, f))
            thumbnail_label.bind("<Button-3>", lambda e, f=result_frame: self._on_result_right_click(e, f))
            result_frame.bind("<Button-3>", lambda e, f=result_frame: self._on_result_right_click(e, f))
