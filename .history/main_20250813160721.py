...
class MusicPlayer:
    ...
    def _update_back_buttons_visibility(self, current_tab_text):
        ...
        try:
            ...
            if hasattr(self, 'playlist_back_btn_sorties') and self.playlist_back_btn_sorties and self.playlist_back_btn_sorties.winfo_exists():
                self.playlist_back_btn_sorties.place_forget()
            if hasattr(self, 'playlist_back_btn_playlists') and self.playlist_back_btn_playlists and self.playlist_back_btn_playlists.winfo_exists():
