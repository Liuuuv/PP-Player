...
class MusicPlayer:
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            # Créer un frame pour chaque élément avec une bordure visible
            ...
            # Utiliser grid pour un meilleur contrôle
            item_frame.columnconfigure(0, weight=0)  # Miniature
            item_frame.columnconfigure(1, weight=1)  # Texte
            item_frame.columnconfigure(2, weight=0)  # Durée (fixed)
            item_frame.columnconfigure(3, weight=0)  # Bouton
            ...
            thumbnail_label.grid(row=0, column=0, sticky='w', padx=(0,10))
            
            # Frame pour le texte
            text_frame = ttk.Frame(item_frame)
            text_frame.grid(row=0, column=1, sticky='we')
            ...
            delete_btn = tk.Button(
                ...
                bg='#ff4444',  # Rouge pour être visible
