...
class MusicPlayer:
    ...
    def _check_scroll_position(self):
        print(self.current_search_batch)
    ...
    def _load_more_search_results(self):
        ...
        # Si on a affiché tous les résultats locaux et qu'il y en a potentiellement plus
            ...
            threading.Thread(
                ...
                args=(self.current_search_query, self.total_available_results + self.lazy_load_increment),
                daemon=True
            ).start()

    def _fetch_more_results(self, query, total_count):
