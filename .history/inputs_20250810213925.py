...
def on_space_pressed(self, event):
    ...
    # Vérifier si le focus n'est pas sur un champ de saisie ou une case à cocher
    focused_widget = self.root.focus_get()
    if focused_widget and isinstance(focused_widget, (tk.Entry, tk.Text, tk.Checkbutton)):
        # Si le focus est sur un champ de saisie ou une case à cocher, ne pas intercepter la barre d'espace
        return
