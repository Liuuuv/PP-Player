        ...
        if hasattr(widget, 'config'):
            try:
                ...
                if not isinstance(widget, tk.Button):  # Exclure les boutons
                    ...
                    if hasattr(widget, 'queue_indicator_type') or (hasattr(widget, 'winfo_name') and 'queue_indicator' in str(widget.winfo_name())):
                        # Ne pas changer la couleur du queue_indicator
                        pass
                    else:
