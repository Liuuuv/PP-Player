...
class MusicPlayer:
    ...
    def _add_artist_playlist_result(self, playlist, index, container, target_tab="sorties"):
        ...
        return self.artist_tab_manager.add_artist_playlist_result(playlist, index, container, target_tab)
