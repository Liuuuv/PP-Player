...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        # Positionner la croix comme stats.png et output.png (à droite des onglets, bien visible)
        close_btn.place(in_=self.artist_notebook, relx=1.0, rely=0.0, anchor="ne", x=-5, y=-5)
    ...
    def _search_artist_videos_with_id(self):
        ...
        try:
            ...
            # Configuration pour extraire les vidéos de la chaîne avec plus de métadonnées
            search_opts = {
                'extract_flat': False,  # Extraire les métadonnées complètes
                'quiet': True,
                'no_warnings': True,
                'ignoreerrors': True,
                'skip_download': True,  # Ne pas télécharger, juste extraire les infos
                'writeinfojson': False,
    ...
    def _add_artist_result(self, video, index, container):
        ...
        try:
            ...
            # Date et durée sous le titre (format: DD/MM/YYYY ● MM:SS)
            ...
            combined_text = f"{date_text} ● {duration_text}"
            
            date_duration_label = tk.Label(
                text_frame,
                text=combined_text,
                bg='#4a4a4a',
                fg='#aaaaaa',
            ...
            date_duration_label.grid(row=1, column=0, sticky='ew', pady=(0, 1))
            
            # Stocker les données vidéo
            result_frame.video_data = video
            result_frame.title_label = title_label
            result_frame.duration_label = date_duration_label
            result_frame.thumbnail_label = thumbnail_label
            ...
            date_duration_label.bind("<Double-1>", on_artist_video_double_click)
