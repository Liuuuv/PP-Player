        ...
        def search_videos():
            try:
                ...
                with YoutubeDL(search_opts) as ydl:
                    ...
                    channel_urls_to_try = []
                    if channel_id:
                        # Utiliser UNIQUEMENT le format officiel avec l'ID
                        base_channel_url = f"https://www.youtube.com/channel/{channel_id}"
                        channel_urls_to_try.append(base_channel_url + '/videos')
                        print(f"URL chaîne construite avec ID: {base_channel_url}")
                        print("ID de chaîne trouvé - ignorer toutes les variantes d'URL")
                    else:
                        print("Aucun ID de chaîne trouvé - impossible de récupérer les vidéos")
                        # Ne plus essayer de variantes si on ne trouve pas l'ID
