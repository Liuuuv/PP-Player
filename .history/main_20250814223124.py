...
class MusicPlayer:
    ...
    def switch_library_tab(self, tab_name):
        ...
        # Vérifier si la queue a changé quand on va dans l'onglet téléchargées
    ...
    def _check_and_update_downloads_queue(self):
        ...
        try:
            # Créer une représentation de la queue actuelle
            current_queue = []
            if hasattr(self, 'main_playlist') and self.main_playlist:
                current_queue = list(self.main_playlist)  # Copie de la liste
            ...
            if not hasattr(self, '_last_downloads_queue'):
                ...
                self._last_downloads_queue = current_queue
                return
            
            # Comparer avec la queue précédente
            if current_queue != self._last_downloads_queue:
    ...
    def _update_saved_downloads_queue(self):
        ...
        try:
            if hasattr(self, 'main_playlist') and self.main_playlist:
                self._last_downloads_queue = list(self.main_playlist)
            else:
                self._last_downloads_queue = []
        except Exception as e:
