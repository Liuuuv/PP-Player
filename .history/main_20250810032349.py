    ...
    def stop_preview(self):
        ...
        try:
            ...
            if self.preview_original_state:
                if self.preview_original_state['current_song']:
                    # Recharger la musique précédente
                    pygame.mixer.music.load(self.preview_original_state['current_song'])
                    
                    # Restaurer l'état de lecture
                    if self.preview_original_state['was_playing'] and not self.preview_original_state['paused']:
                    ...
                    # Aucune musique n'était en cours
                    self.paused = True
                    self.play_button.config(image=self.icons["play"], text="Play")
