...
def setup_search_tab(self):
    ...
    # Frame pour les cases à cocher (à droite de la barre de recherche)
    checkboxes_frame = ttk.Frame(search_input_frame)
    checkboxes_frame.pack(side=tk.RIGHT, padx=(10, 0))
    ...
    artists_checkbox.pack(side=tk.LEFT, padx=(0, 10))
    ...
    tracks_checkbox.pack(side=tk.LEFT)
