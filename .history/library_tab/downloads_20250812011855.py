...
def _show_no_results_message(self):
    ...
    # Créer un frame centré pour le message
    no_results_frame = ttk.Frame(self.downloads_container)
    no_results_frame.pack(fill="both", expand=True)
    
    # Créer un frame interne pour centrer le contenu verticalement et horizontalement
    center_frame = ttk.Frame(no_results_frame)
