...
def _clear_library_search(self):
    """Vide le champ de recherche de la bibliothèque et affiche tous les fichiers"""
...
def _on_library_search_change(self, event):
    """Gère la recherche en temps réel dans la bibliothèque"""
    if not hasattr(self, 'library_search_entry') or not hasattr(self, 'all_downloaded_files'):
        return
    ...
    # Filtrer les fichiers en fonction de la requête de recherche
    filtered_files = []
