...
def _show_playlist_content_window(self, playlist_name):
    ...
    # Bind mousewheel avec gestion d'erreurs
    def _on_mousewheel(event):
        try:
            ...
            print(f"Erreur scroll playlist: {e}")
            pass
    ...
    container.bind("<Button-4>", _on_mousewheel)  # Linux
    container.bind("<Button-5>", _on_mousewheel)  # Linux
