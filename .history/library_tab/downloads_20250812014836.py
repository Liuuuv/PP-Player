...
def _show_no_results_message(self):
    ...
    # Frame qui prend toute la place pour empêcher le scroll
    ...
    # Frame pour centrer le contenu à l'intérieur
    no_results_frame = tk.Frame(
        container_frame,
        bg='#3d3d3d'
    )
    no_results_frame.place(relx=0.5, rely=0.5, anchor="center")
    ...
    if has_icon:
        try:
            ...
            icon_frame.pack(expand=True, pady=(20, 10))
            ...
            icon_label.pack()
            print("Debug: Image 'none' affichée")
    ...
    if not has_icon:
        ...
        emoji_frame.pack(expand=True, pady=(20, 10))
    ...
    text_frame.pack(expand=True, pady=(0, 20))
