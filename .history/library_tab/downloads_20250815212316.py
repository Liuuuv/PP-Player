...
def _display_filtered_downloads(self, files_to_display, preserve_scroll=False):
    ...
    # Si on a beaucoup de fichiers, utiliser l'affichage optimisé par batch
    if total_files > INITIAL_DISPLAY_BATCH_SIZE:
        self._display_downloads_optimized(files_to_display)
    else:
        # Pour les petites listes, affichage normal mais optimisé
