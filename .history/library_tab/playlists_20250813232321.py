...
def _add_playlist_card(self, parent_frame, playlist_name, songs, column):
    ...
    try:
        ...
        thumbnails_frame = tk.Frame(card_frame, bg='#4a4a4a', width=160, height=160)
    ...
    try:
        ...
        for ext in image_extensions:
            ...
            if os.path.exists(thumbnail_path):
                ...
                # Redimensionner à une taille adaptée pour 4 par ligne (75x75)
                img_resized = img_cropped.resize((75, 75), Image.Resampling.LANCZOS)
