...
def _add_download_item(self, filepath):
    ...
    try:
        ...
        thumbnail_label.grid(row=0, column=0, sticky='nsew', padx=(5, 2), pady=3)
        ...
        # 2. Texte (colonne 1)
        # Utiliser le nom complet sans troncature pour prendre toute la place horizontale
        # display_title = filename
        # if display_title.lower().endswith('.mp3'):
        #     display_title = display_title[:-4]  # Enlever l'extension .mp3
        truncated_title = self._truncate_text_for_display(filename, 50, 1)
        ...
        title_label.grid(row=0, column=1, sticky='nsew', padx=(0, 5), pady=0)
