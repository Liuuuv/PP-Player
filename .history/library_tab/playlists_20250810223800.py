...
def _add_playlist_window_item(self, container, filepath, playlist_name, song_index):
    ...
    try:
        ...
        # Configuration de la grille en 5 colonnes : miniature, texte, durée, bouton jouer, bouton supprimer
        ...
        item_frame.columnconfigure(3, minsize=80, weight=0)  # Bouton jouer
        ...
        # 2. Texte (colonne 1) avec numéro
        title_with_number = f"{song_index + 1}. {filename}"
        truncated_title = self._truncate_text_for_display(title_with_number, max_width_pixels=300, font_family='TkDefaultFont', font_size=9)
        ...
        title_label.grid(row=0, column=1, sticky='nsew', padx=(0, 2), pady=4)
        ...
        # 4. Bouton "Jouer depuis la playlist" (colonne 3)
        play_btn = tk.Button(
            item_frame,
        ...
        play_btn.grid(row=0, column=3, sticky='ns', padx=(0, 5), pady=8)
        ...
        for widget in [item_frame, thumbnail_label, title_label, duration_label]:
