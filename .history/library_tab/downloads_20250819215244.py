                ...
                if hasattr(self, '_virtual_files_list'):
                    ...
                    if loaded_files > 0:
                        ...
                        if bbox:
                            ...
                            # Ajuster la position du scroll selon l'index virtuel
                            if total_files > 0:
                                scroll_position = self._virtual_start_index / total_files
                                self.downloads_canvas.yview_moveto(scroll_position)
                        else:
                            # Fallback normal
                            self.downloads_canvas.configure(scrollregion=self.downloads_canvas.bbox("all"))
                else:
