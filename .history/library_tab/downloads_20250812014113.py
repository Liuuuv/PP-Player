...
def _show_no_results_message(self):
    ...
    print("Debug: RETOUR AU TEST ROUGE")
    
    # RETOUR AU TEST QUI FONCTIONNAIT - FRAME PLUS LARGE
    test_frame = tk.Frame(
        self.downloads_container,
        bg='red',
        width=600,  # Plus large pour le texte
        height=200,
        relief='solid',
        bd=5
    )
    ...
    # Texte plus court et centré
    test_label = tk.Label(
        test_frame,
        text="AUCUN RÉSULTAT",  # Texte plus court
        bg='red',
        fg='yellow',
        font=('Arial', 24, 'bold'),
        bd=0
    ...
    # Deuxième ligne avec un texte plus petit
    ...
    print("Debug: Test rouge restauré")
