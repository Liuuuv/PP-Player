...
def _display_playlists(self):
    ...
    print("DEBUG PLAYLIST ITEMS:", playlist_items)
...
def _add_playlist_card(self, parent_frame, playlist_name, songs, column):
    ...
    try:
        ...
        thumbnails_frame = tk.Frame(card_frame, bg='#4a4a4a', width=125, height=80)
        thumbnails_frame.grid(row=0, column=0, sticky='nsew', padx=5, pady=5)
        ...
        title_label.grid(row=1, column=0, sticky='ew', padx=10, pady=(3, 1))
