...
def _show_no_results_message(self):
    ...
    if has_icon:
        try:
            ...
            # Agrandir l'image (taille doublée par exemple)
            new_size = (original_pil.width * 0.9, original_pil.height * 0.9)
            enlarged_image = original_pil.resize(new_size, Image.Resampling.LANCZOS)
