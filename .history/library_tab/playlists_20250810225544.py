...
def _add_playlist_song_item(self, filepath, playlist_name, song_index):
    ...
    try:
        ...
        item_frame.columnconfigure(0, minsize=35, weight=0)  # Numéro (réduit)
        item_frame.columnconfigure(1, minsize=70, weight=0)  # Miniature (réduit)
        item_frame.columnconfigure(2, weight=1)              # Texte (prend tout l'espace restant)
        item_frame.columnconfigure(3, minsize=50, weight=0)  # Durée (réduit)
        item_frame.columnconfigure(4, minsize=40, weight=0)  # Bouton (réduit)
        ...
        number_label.grid(row=0, column=0, sticky='nsew', padx=(5, 2), pady=2)
        ...
        thumbnail_label.grid(row=0, column=1, sticky='nsew', padx=(2, 2), pady=2)
        thumbnail_label.grid_propagate(False)
        
        # Charger la miniature
        self._load_download_thumbnail(filepath, thumbnail_label)
        
        # 3. Texte (colonne 2) - prend toute la place disponible
        title_label = tk.Label(
            item_frame,
            text=filename,  # Afficher le nom complet sans troncature
            bg=bg_color,
            fg='white',
            font=('TkDefaultFont', 9),
            anchor='w',
        ...
        title_label.grid(row=0, column=2, sticky='nsew', padx=(0, 2), pady=8)  # Réduire le padding à droite
        ...
        remove_btn.grid(row=0, column=4, sticky='ns', padx=(0, 5), pady=8)
