...
def _update_downloads_queue_visual(self):
    ...
    try:
        print('oui', self.current_library_tab)
        ...
        if not (hasattr(self, 'downloads_container') and 
                ...
                self.current_library_tab == "downloads"):
            return
        ...
        for widget in self.downloads_container.winfo_children():
            if hasattr(widget, 'filepath'):  # C'est un frame d'élément de téléchargement
                ...
                print(f"Debug: Vérification de la queue pour le fichier {filepath}")
                ...
                if hasattr(widget, 'queue_indicator') and hasattr(widget, 'is_in_queue'):
                    if widget.is_in_queue:
                        self.show_queue_indicator(widget.queue_indicator)
                    else:
                        self.hide_queue_indicator(widget.queue_indicator)
