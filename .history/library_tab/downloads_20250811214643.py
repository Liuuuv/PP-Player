...
def show_downloads_content(self):
    ...
    # Canvas avec scrollbar pour les téléchargements (version virtualisée)
    ...
    # Bind des événements pour la virtualisation
...
def _on_mouse_wheel(self, event):
    ...
    if not hasattr(self, 'filtered_files') or len(self.filtered_files) <= 100:
        return
...
def _update_scrollbar_range(self):
    ...
    if hasattr(self, 'filtered_files') and len(self.filtered_files) > 100:
        self._update_scrollbar()
    else:
        self.downloads_scrollbar.set(0, 1)