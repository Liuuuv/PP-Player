...
def _add_playlist_card(self, parent_frame, playlist_name, songs, column):
    ...
    try:
        ...
        title_label = tk.Label(
            card_frame,
            text=self._truncate_text_for_display(playlist_name, max_width=PLAYLIST_CARD_NAME_MAX_WIDTH, max_lines=1, font_family=PLAYLIST_CARD_NAME_FONT[0], font_size=PLAYLIST_CARD_NAME_FONT[1]),
            bg='#4a4a4a',
            fg='white',
