...
def _display_filtered_downloads(self, files_to_display):
    ...
    # Mettre à jour l'affichage visuel des barres noires de queue après l'affichage filtré
...
def _display_files_batch_optimized(self, files_to_display, start_index, total_files, batch_size=50):
    ...
    if end_index < len(files_to_display):
        ...
        # Mettre à jour l'affichage visuel des barres noires de queue après le chargement complet
        if hasattr(self, '_update_downloads_queue_visual'):
            self._update_downloads_queue_visual()
