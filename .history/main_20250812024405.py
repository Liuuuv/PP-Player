...
class MusicPlayer:
    ...
    def _display_artist_videos(self, videos):
        """Affiche les vidéos de l'artiste dans la zone YouTube"""
        # Supprimer le message de chargement
        if hasattr(self, 'artist_loading_label'):
            self.artist_loading_label.destroy()
        ...
        # Afficher les vidéos en utilisant la fonction normale d'ajout de résultats
