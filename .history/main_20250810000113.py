...
class MusicPlayer:
    ...
    def _add_playlist_song_item(self, filepath, playlist_name, song_index):
        ...
        try:
            ...
            # 4. Bouton "Supprimer de la playlist" (colonne 3) avec icône delete
            remove_btn = tk.Button(
                item_frame,
            ...
            remove_btn.grid(row=0, column=3, sticky='ns', padx=(0, 10), pady=8)
    ...
    def load_icons(self):
        ...
        icon_names = {
            ...
            "pause": "pause.png",
            "delete": "delete.png",
            "back": "prev.png"  # Utiliser la même icône que prev pour back
        }
