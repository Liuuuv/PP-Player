...
class MusicPlayer:
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            item_frame.bind("<Double-1>", lambda e, f=filepath: self._play_playlist_item(f) or select_item())
            thumbnail_label.bind("<Double-1>", lambda e, f=filepath: self._play_playlist_item(f) or select_item())
            title_label.bind("<Double-1>", lambda e, f=filepath: self._play_playlist_item(f) or select_item())
            ...
            thumbnail_label.bind("<Double-1>", lambda e, f=filepath: self._play_playlist_item(f))
            title_label.bind("<Double-1>", lambda e, f=filepath: self._play_playlist_item(f))
