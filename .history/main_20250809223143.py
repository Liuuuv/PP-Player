...
class MusicPlayer:
    def __init__(self, root):
        ...
        # Faire pointer self.main_playlist vers la playlist principale pour compatibilité
    ...
    def setup_search_tab(self):
        ...
        # Playlist Frame (left side - fixed width)
    ...
    def setup_controls(self):
        ...
        # Frame volume offset à gauche
        volume_offset_frame = ttk.Frame(buttons_volume_frame)
        ...
        self.volume_offset_slider.pack(padx=10)
        ...
        self.volume_slider.pack(padx=10)

        # Configuration des colonnes
        buttons_volume_frame.grid_columnconfigure(0, weight=1)  # volume offset
        buttons_volume_frame.grid_columnconfigure(1, weight=0)  # boutons centrés
        buttons_volume_frame.grid_columnconfigure(2, weight=1)  # volume
