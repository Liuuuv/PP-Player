...
def _display_windowed_playlist(self):
        ...
        try:
            ...
            # Déterminer la fenêtre à afficher
            current_index = getattr(self, 'current_song_index', 0)
            start_index, end_index = self._calculate_window_bounds(current_index)
            
            print(f"🪟 DEBUG: Fenêtre [{start_index}:{end_index}] autour de l'index {current_index}")
            ...
            self._add_window_indicators(start_index, end_index)
