...
MAIN_PLAYLIST_CONFIG = {
    ...
    # Paramètres de chargement/déchargement intelligent
    'enable_smart_loading': True,        # Activer le chargement/déchargement intelligent
    'auto_unload_unused': True,          # Décharger automatiquement les éléments inutiles
    ...
    'reload_on_song_change': True,       # Recharger automatiquement à chaque changement de musique
