...
MAIN_PLAYLIST_CONFIG = {
    ...
    'windowing_threshold': 20,         # Nombre de musiques à partir duquel activer le fenêtrage
    ...
    'enable_infinite_scroll': False,  # Désactivé car on utilise le windowing à la place
