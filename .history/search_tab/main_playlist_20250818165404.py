...
def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            if artist:
                ...
                artist_label.pause_counter = MAIN_PLAYLIST_TITLE_ANIMATION_STARTUP  # Compteur pour la pause entre les cycles
                artist_label.max_width = MAIN_PLAYLIST_TITLE_MAX_WIDTH  # Largeur maximale du titre
                artist_label.animation_active = False  # Animation en cours
                artist_label.full_text = title_label.cget('text')  # Texte complet du titre
                artist_label.pause_cycles = MAIN_PLAYLIST_TITLE_ANIMATION_PAUSE
