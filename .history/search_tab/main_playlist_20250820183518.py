...
def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            for widget in widgets_to_bind:
                ...
                if hasattr(self, 'playlist_canvas') and self.main_playlist_canvas:
                ...
                if auto_scroll:
                    try:
                        ...
                        if (hasattr(self, 'main_playlist_container') and self.main_playlist_container.winfo_exists() and
                            hasattr(self, 'playlist_canvas') and self.main_playlist_canvas.winfo_exists()):
...
def _smooth_scroll_to_position(self, target_position, duration, is_manual):
    ...
    try:
        ...
        if not (hasattr(self, 'playlist_canvas') and self.main_playlist_canvas.winfo_exists()):
            return
        ...
        try:
            ...
            try:
                if hasattr(self, 'playlist_canvas') and self.main_playlist_canvas.winfo_exists():
...
def _update_canvas_scroll_region(self):
        ...
        try:
            ...
            if not (hasattr(self, 'playlist_canvas') and hasattr(self, 'main_playlist_container')):
                return
...
def _get_current_view_position(self):
        ...
        try:
            if not hasattr(self, 'playlist_canvas') or not self.main_playlist_canvas.winfo_exists():
                return None
...
def _setup_progressive_scroll_detection(self):
        ...
        try:
            ...
            if not (hasattr(self, 'playlist_canvas') and self.main_playlist_canvas):
                return
