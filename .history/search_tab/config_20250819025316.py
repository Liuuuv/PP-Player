...
MAIN_PLAYLIST_CONFIG = {
    ...
    # Paramètres de scroll infini
    'enable_infinite_scroll': True,    # Activer le scroll infini
    'scroll_threshold': 0.1,           # Seuil pour charger plus (10% du haut/bas)
    ...
    # === NOUVEAU SYSTÈME : CHARGEMENT PROGRESSIF ===
    'enable_progressive_loading': True,   # Activer le système de chargement progressif
    'initial_load_after_current': 10,     # Charger 10 musiques après la courante au départ
    'load_more_on_scroll': 10,           # Charger 10 de plus en scrollant vers le bas
    ...
    'max_load_per_scroll': 10,           # Nombre maximum d'éléments à charger par scroll
    
    # === NOUVEAU SYSTÈME : DÉCHARGEMENT INTELLIGENT ===
    'enable_smart_unloading': True,      # Activer le déchargement intelligent
    'max_loaded_items': 50,              # Nombre maximum d'éléments chargés avant déchargement
    'preserve_current_view': True,       # Préserver les éléments visibles actuellement
    'preserve_items_after_current': 20,  # Nombre d'éléments à préserver après la position courante
    'preserve_items_before_current': 10, # Nombre d'éléments à préserver avant la position courante
    ...
    # Paramètres de debug
    'debug_windowing': False,          # Afficher les infos de debug du fenêtrage
    'debug_scroll': False,             # Afficher les infos de debug du scroll
