...
def _append_progressive_items(self, start_index, end_index):
        ...
        try:
            ...
            # DÉCHARGEMENT INTELLIGENT : Seulement si on a chargé de nouveaux éléments
            if loaded_count > 0:
                print(f"DEBUG: {loaded_count} nouveaux éléments chargés, déclenchement du déchargement intelligent")
