...
def _show_search_results(self):
    ...
    try:
        print("DEBUG: _show_search_results - début")
        ...
        if hasattr(self, 'youtube_canvas') and self.youtube_canvas is not None:
            try:
                ...
                print(f"DEBUG: Erreur youtube_canvas: {e}")
        
        # Mettre à jour le compteur de résultats
        print("DEBUG: Avant _update_results_counter")
        self._update_results_counter()
        print("DEBUG: _show_search_results - fin")
    except Exception as e:
