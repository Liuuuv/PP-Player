...
def _show_search_results(self):
    ...
    try:
        ...
        if hasattr(self, 'youtube_results_container'):
            if self.youtube_results_container and self.youtube_results_container.winfo_exists():
                children = self.youtube_results_container.winfo_children()
                print(f"DEBUG: Container a {len(children)} enfants")
            else:
                print("DEBUG: Container de résultats n'existe pas")
        else:
            print("DEBUG: Pas de youtube_results_container")
...
def _display_search_results_from_cache(self, results):
    ...
    def display_batch(batch_start):
        try:
            ...
            if not hasattr(self, 'youtube_results_container') or not self.youtube_results_container.winfo_exists():
