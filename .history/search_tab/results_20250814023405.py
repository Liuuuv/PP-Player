    ...
    try:
        ...
        if hasattr(self, 'saved_search_state'):
            ...
            if saved_results:
                ...
                self.root.after(50, lambda: self._display_search_results(saved_results))
            ...
            if scroll_position:
                try:
                    ...
                    if hasattr(self, 'youtube_canvas') and self.youtube_canvas.winfo_exists():
                        ...
                        self.root.after(100, lambda: self.youtube_canvas.yview_moveto(scroll_top))
                except:
                    pass
...
def _display_search_results(self, results, scroll_position=None):
    ...
    try:
        ...
        # Configurer la scrollbar avec le canvas après que _show_search_results ait configuré le canvas
        if hasattr(self, 'scrollbar') and hasattr(self, 'youtube_canvas'):
            try:
                if self.scrollbar.winfo_exists() and self.youtube_canvas.winfo_exists():
                    ...
                    print("DEBUG: Scrollbar configurée avec le canvas")
            except Exception as e:
        ...
        if scroll_position:
            ...
            # Attendre que tous les résultats soient ajoutés avant de restaurer le scroll
