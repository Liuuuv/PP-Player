        ...
        try:
            ...
            for widget in widgets_to_bind:
                ...
                if hasattr(self, 'playlist_canvas') and self.playlist_canvas:
                    ...
                    widget.bind("<MouseWheel>", tools.on_mousewheel_lazy, add="+")
                    widget.bind("<Button-4>", tools.on_mousewheel_lazy, add="+")  # Linux
                    widget.bind("<Button-5>", tools.on_mousewheel_lazy, add="+")  # Linux
