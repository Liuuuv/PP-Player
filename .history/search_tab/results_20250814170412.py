...
def _on_result_click_old_backup(self, frame, add_to_playlist=True):
        """ANCIENNE VERSION - SAUVEGARDE - Gère le clic sur un résultat"""
        # Cette fonction est gardée en backup au cas où
        pass
