...
def _check_and_unload_items(self, current_index):
        ...
        try:
            ...
            # si l'utilisateur regarde en dessous ou si on vient d'utiliser find.png
            prioritize_before = user_looking_below or getattr(self, '_just_used_find_button', False)
