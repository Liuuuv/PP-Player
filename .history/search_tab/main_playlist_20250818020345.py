...
def _display_main_playlist(self):
        ...
        try:
            ...
            try:
                from search_tab.config import should_use_windowing, get_main_playlist_config
...
def _display_full_playlist(self):
        """Affiche tous les éléments de la playlist (mode complet)"""
        try:
