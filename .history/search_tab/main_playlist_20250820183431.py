...
def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            if not (hasattr(self, 'playlist_container') and self.main_playlist_container.winfo_exists()):
...
def select_playlist_item(self, item_frame=None, index=None, auto_scroll=True, is_manual=False):
    ...
    try:
        if hasattr(self, 'playlist_container') and self.main_playlist_container.winfo_exists():
            ...
            if item_frame.winfo_exists():
                ...
                if auto_scroll:
                    try:
                        ...
                        if (hasattr(self, 'playlist_container') and self.main_playlist_container.winfo_exists() and
...
def _refresh_windowed_playlist_display(self, force_recreate=False):
        ...
        try:
            ...
            can_reuse = (not force_recreate and
                        ...
                        hasattr(self, 'playlist_container') and self.main_playlist_container.winfo_exists() and
...
def _progressive_load_system(self):
        ...
        try:
            ...
            currently_loaded = len(self.main_playlist_container.winfo_children()) if hasattr(self, 'playlist_container') else 0
...
def _reorder_playlist_items(self):
        ...
        try:
            if not hasattr(self, 'playlist_container') or not self.main_playlist_container.winfo_exists():
                return
