        ...
        if hasattr(self, 'thumbnail_frame') and self.thumbnail_frame is not None:
            try:
                if self.thumbnail_frame.winfo_exists():
                    ...
                    print("DEBUG: thumbnail_frame masquée")
                else:
                    print("DEBUG: thumbnail_frame n'existe pas")
            except Exception as e:
                print(f"DEBUG: Erreur masquage thumbnail_frame: {e}")
        else:
            print("DEBUG: Pas de thumbnail_frame")
