            ...
            if not is_channel:
                ...
                if artist or album:
                    ...
                    if artist:
                        ...
                        # Binding pour le clic simple (debug)
                        def on_artist_click(event, artist_name=artist, video_data=video):
                            print(f"DEBUG: Clic simple sur artiste: {artist_name}")
                        
                        # Binding pour le double-clic sur l'artiste (ouvrir l'artist_tab)
                        ...
                        create_tooltip(artist_label, f"Double-clic: ouvrir l'onglet artiste pour {artist}")
            ...
            def on_result_double_click(event, frame=result_frame):
                ...
                if event.state & 0x1:  # Shift est enfoncé
                    ...
                    if "https://www.youtube.com/channel/" in video_url or "https://www.youtube.com/@" in video_url:
                        # Pour les chaînes, ouvrir l'artist_tab
