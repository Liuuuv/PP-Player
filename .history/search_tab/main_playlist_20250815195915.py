...
def _refresh_windowed_playlist_display(self):
        ...
        try:
            ...
            if (hasattr(self, '_last_window_start') and hasattr(self, '_last_window_end') and
                self._last_window_start == start_index and self._last_window_end == end_index):
...
def _add_playlist_indicator(self, text, position):
        ...
        try:
            ...
            if hasattr(self, 'create_tooltip'):
                if position == "top":
                    self.create_tooltip(indicator_label, "Cliquez pour remonter de 15 chansons")
                else:
                    self.create_tooltip(indicator_label, "Cliquez pour descendre de 15 chansons")
