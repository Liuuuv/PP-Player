...
def _should_load_more_results(self):
    ...
    # Debug pour comprendre pourquoi le chargement ne se fait pas
    ...
    if (self.is_loading_more or 
        ...
        print(f"DEBUG: Conditions bloquantes détectées, pas de chargement")
        return False
    ...
    try:
        ...
        if scroll_bottom > 0.8:
            print(f"DEBUG: Scroll > 80%, chargement autorisé")
            return True
        
        print(f"DEBUG: Scroll < 80%, pas de chargement")
        return False
    except Exception as e:
