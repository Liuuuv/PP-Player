...
MAIN_PLAYLIST_CONFIG = {
    ...
    'window_size_small': 25,           # Taille de fenêtre pour playlists moyennes (50-100)
    'window_size_medium': 30,          # Taille de fenêtre pour playlists grandes (100-200)
    'window_size_large': 40,           # Taille de fenêtre pour très grandes playlists (200+)
