...
class MusicPlayer:
    ...
    def _clear_main_playlist(self):
        """Vide complètement la liste de lecture principale"""
        ...
        result = messagebox.askyesno(
            ...
            f"Êtes-vous sûr de vouloir supprimer toutes les {len(self.main_playlist)} musiques de la liste de lecture ?",
            parent=self.root
        )
