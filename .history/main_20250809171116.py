...
class MusicPlayer:
    ...
    def get_adaptive_waveform_data(self, canvas_width):
        ...
        target_resolution = max(canvas_width * 2, 1000)  # Minimum 1000 échantillons
    ...
    def draw_waveform_around(self, time_sec, window_sec=5):
        ...
        if total_length > 0:
            ...
            window_start_time = (start / len(self.waveform_data)) * total_length
            window_end_time = (end / len(self.waveform_data)) * total_length
