...
def on_space_pressed(self, event):
    """Gère l'appui sur la barre d'espace - uniquement pause/play"""
    ...
    # Retirer immédiatement le focus de tout widget pour éviter l'activation des boutons
    # Ceci doit être fait AVANT tout autre traitement
    self.root.focus_set()
    
    # Uniquement pause/play, rien d'autre
    self.play_pause()
