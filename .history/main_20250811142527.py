...
class MusicPlayer:
    ...
    def _perform_initial_search(self, query):
        ...
        try:
            ...
            search_opts = {
                ...
                'ignoreerrors': True,
                'socket_timeout': 30,  # Timeout de 30 secondes
            }
    ...
    def _clear_results(self):
        ...
        try:
            # Annuler les recherches en cours pour éviter les erreurs de widgets détruits
            self.search_cancelled = True
