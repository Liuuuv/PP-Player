...
def create_ui(self):
    ...
    self.errors_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-150, y=-5)
    ...
    # Positionner le bouton à droite du bouton output
    self.settings_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-195, y=-5)
    create_tooltip(self.errors_button, "Erreurs système\nAffiche les erreurs détectées dans l'application")
