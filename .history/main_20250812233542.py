            ...
            try:
                ...
                with YoutubeDL(search_opts) as ydl:
                    ...
                    if not all_playlists:
                        ...
                        # Essayer de trouver des playlists via une recherche ciblée
                        search_queries = [
                            f"ytsearch20:{self.current_artist_name} playlist",
                            f"ytsearch15:{self.current_artist_name} album playlist",
