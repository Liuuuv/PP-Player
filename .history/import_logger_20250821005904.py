...
class ImportLogger:
    ...
    def start_session(self, session_type, source_info):
        ...
        print("🔄 Logger: Entrée dans start_session")
        print(f"🔍 Logger: Paramètres - type: {session_type}, source: {source_info}")
        
        print("🔄 Logger: Acquisition du lock...")
        with self.lock:
            print("🔄 Logger: Lock acquis")
            
            print("🔄 Logger: Génération timestamp...")
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            session_id = f"{session_type}_{timestamp}"
            print(f"🔄 Logger: Session ID généré: {session_id}")
            
            print("🔄 Logger: Création dictionnaire session...")
            ...
            print("🔄 Logger: Dictionnaire session créé")
            
            print("🔄 Logger: Premier log_info...")
            self.log_info(f"Démarrage de la session {session_type}")
            print("🔄 Logger: Premier log_info terminé")
            
            print("🔄 Logger: Deuxième log_info...")
            self.log_info(f"Source: {source_info}")
            print("🔄 Logger: Deuxième log_info terminé")
            
            print(f"🔄 Logger: Retour session_id: {session_id}")
            return session_id
