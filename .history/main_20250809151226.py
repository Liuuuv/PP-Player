...
class MusicPlayer:
    ...
    def create_ui(self):
        ...
        # Left side of bottom frame (song info and progress)
        left_bottom_frame = ttk.Frame(bottom_frame)
        left_bottom_frame.pack(side=tk.LEFT, fill=tk.X, expand=True)
        
        # Song Info
        self.song_label = ttk.Label(
            left_bottom_frame, text="No track selected", 
        ...
        self.progress = ttk.Scale(
            left_bottom_frame, from_=0, to=100, orient=tk.HORIZONTAL,
        ...
        # Time Labels
        time_frame = ttk.Frame(left_bottom_frame)
        ...
        # Right side of bottom frame (control buttons)
        right_bottom_frame = ttk.Frame(bottom_frame)
        right_bottom_frame.pack(side=tk.RIGHT, fill=tk.Y)
        
        # Buttons Frame (aligned to right)
        button_frame = ttk.Frame(right_bottom_frame)
        ...
        # Waveform and other controls below
        ...
        self.show_waveform_btn.pack(side=tk.LEFT, pady=(0, 10))
        
        # Volume Control
        volume_frame = ttk.Frame(control_frame)
        volume_frame.pack(side=tk.RIGHT, fill=tk.X, pady=10)
