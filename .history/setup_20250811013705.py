...
def setup_controls(self):
        ...
        # Time Labels (à gauche et à droite, au niveau des boutons)
        self.current_time_label = ttk.Label(volume_offset_frame, text="00:00")
        self.current_time_label.pack(side=tk.LEFT, anchor="sw", pady=(10, 0))
        
        # Time Labels à droite
        time_right_frame = ttk.Frame(buttons_volume_frame)
        time_right_frame.grid(row=0, column=2, sticky="e")
        
        self.song_length_label = ttk.Label(time_right_frame, text="00:00")
        self.song_length_label.pack(side=tk.RIGHT, anchor="se", pady=(10, 0))
