...
class MusicPlayer:
    ...
    def _add_playlist_song_item(self, filepath, playlist_name, song_index):
        ...
        try:
            ...
            item_frame.columnconfigure(0, minsize=20, weight=0)  # Numéro
            ...
            number_label = tk.Label(
                item_frame,
                text=str(song_index + 1) + "u",  # +1 pour commencer à 1 au lieu de 0
                bg=bg_color,
                fg='white',
                font=('TkDefaultFont', 5, 'bold'),
                anchor='center'
            )
            number_label.grid(row=0, column=0, sticky='nsew', padx=(5, 5), pady=8)
            ...
            remove_btn = tk.Button(
                ...
                command=lambda: self._remove_from_playlist(filepath, playlist_name),
                bg='#ff4444',
                activebackground='#ff6666',
                relief='flat',
                bd=0,
    ...
    def _remove_from_playlist(self, filepath, playlist_name):
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            if show_numbers:
                number_label.bind("<Double-1>", lambda e: on_item_click())
    ...
    def _refresh_playlist_display(self):
        ...
        for i, filepath in enumerate(self.main_playlist):
            self._add_playlist_item(filepath, song_index=i)
