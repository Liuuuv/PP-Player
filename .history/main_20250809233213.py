...
class MusicPlayer:
    ...
    def save_config(self):
        ...
        try:
            ...
            print(f"Sauvegarde config: volume={self.volume}, offsets={len(self.volume_offsets)} éléments")
        ...
        try:
            ...
            if os.path.exists(self.config_file):
                ...
                if "volume_offsets" in config:
                    ...
                    print(f"Offsets chargés: {len(self.volume_offsets)} éléments")
            else:
    ...
    def _update_volume_sliders(self):
        ...
        try:
            ...
            if hasattr(self, 'volume_slider'):
                print(f"Mise à jour slider volume: {self.volume * 100}")
                self.volume_slider.set(self.volume * 100)
            else:
                print("volume_slider n'existe pas encore")
            
            # Mettre à jour le slider d'offset (sera mis à jour quand une musique sera jouée)
            if hasattr(self, 'volume_offset_slider'):
                print(f"Mise à jour slider offset: {self.volume_offset}")
                self.volume_offset_slider.set(self.volume_offset)
            else:
                print("volume_offset_slider n'existe pas encore")
    ...
    def set_volume_offset(self, val):
        ...
        # Sauvegarder l'offset pour la musique en cours
