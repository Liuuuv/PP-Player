...
class ToolTip:
    ...
    def show_tip(self, event=None):
        ...
        # Rendre la fenêtre tooltip transparente aux événements de scroll
        try:
        ...
        # Cacher le tooltip lors d'événements de scroll et laisser passer l'événement
        def on_scroll_hide_tooltip(event):
            self.hide_tip()
            # Ne pas retourner "break" pour laisser l'événement se propager
            return None
        
        # Bind les événements de scroll pour cacher le tooltip
        tw.bind('<MouseWheel>', on_scroll_hide_tooltip)
        tw.bind('<Button-4>', on_scroll_hide_tooltip)  # Linux
        tw.bind('<Button-5>', on_scroll_hide_tooltip)  # Linux
        label.bind('<MouseWheel>', on_scroll_hide_tooltip)
        label.bind('<Button-4>', on_scroll_hide_tooltip)  # Linux
        label.bind('<Button-5>', on_scroll_hide_tooltip)  # Linux
