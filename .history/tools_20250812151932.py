...
def _add_song_item(self, filepath, playlist_name, container, song_index=None):
...
def _load_next_thumbnail(self, container):
    ...
    if self.thumbnail_loading_queue:
        self.root.after(5, lambda: self._load_next_thumbnail(container))  # Délai réduit avec le cache
