...
class MusicPlayer:
    def __init__(self, root):
        ...
        self.pending_queue_last_additions = {}  # Dictionnaire {url: True} pour les ajouts en dernier dans la queue en attente
    ...
    def _clear_main_playlist(self, event=None):
        ...
        # Enlever la miniature sur l'onglet search et afficher la miniature par défaut
        ...
        # Mettre à jour l'affichage des rectangles noirs de la queue
        if hasattr(self, '_update_downloads_queue_visual'):
