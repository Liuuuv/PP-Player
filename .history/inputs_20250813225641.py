...
def show_download_dialog(self):
    """Affiche une boîte de dialogue pour télécharger des musiques ou playlists"""
    dialog = DownloadDialog(self.root, self)
...
class DownloadDialog:
    def __init__(self, parent, music_player):
        ...
        self.dialog.title("Télécharger des musiques")
