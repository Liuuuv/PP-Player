...
def download_youtube_video(self, url, title=None):
    ...
    try:
        ...
        # Ajouter le hook de progression si disponible
        if hasattr(self, '_download_progress_hook'):
...
def refresh_ui_after_changes(self):
    ...
    if hasattr(self, '_count_downloaded_files'):
        self._count_downloaded_files()
    if hasattr(self, '_update_downloads_button'):
    ...
    if hasattr(self, 'save_playlists'):
        self.save_playlists()
