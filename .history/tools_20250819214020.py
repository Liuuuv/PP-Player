...
def save_config(self):
    ...
    try:
        ...
        config = {
            ...
            "virtual_loading": {
                "initial_load_count": getattr(self, 'virtual_initial_load_count', 20),
                "scroll_load_count": getattr(self, 'virtual_scroll_load_count', 10)
            }
        }
...
def _add_song_item(self, filepath_or_video, container, playlist_name=None, song_index=None, item_type="downloads", video_index=None):
    ...
    try:
        ...
        # Retourner le widget créé pour le chargement virtuel
        return item_frame
