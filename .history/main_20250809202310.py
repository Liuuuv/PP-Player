...
class MusicPlayer:
    ...
    def _show_current_song_thumbnail(self):
        ...
        if len(self.playlist) > 0 and self.current_index < len(self.playlist):
            ...
            thumbnail_frame.pack(fill='x', padx=20, pady=50)
            ...
            # Charger la vraie miniature si elle existe
            self._load_download_thumbnail(current_song, thumbnail_label)
            
            # Label pour le titre
            title_label = tk.Label(
                thumbnail_frame,
                text=f"En cours: {self._truncate_text_for_display(filename, max_chars_per_line=40, max_lines=2)}",
                bg='#3d3d3d',
                fg='white',
            ...
            no_song_frame.pack(fill='x', padx=20, pady=50)
            
            no_song_label = tk.Label(
                no_song_frame,
                text="Aucune musique en cours\n♪",
                bg='#3d3d3d',
                fg='#666666',
                font=('TkDefaultFont', 24),
                justify='center'
            )
            no_song_label.pack(pady=50)
