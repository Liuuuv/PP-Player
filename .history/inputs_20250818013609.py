...
def _on_mousewheel(self, event, canvas):
        ...
        # SUPPRESSION TEMPORAIRE: Pas d'interférence avec le scroll de la playlist
        # Laisser Tkinter gérer le scroll normalement
        print(f"🖱️ DEBUG: Scroll normal de Tkinter - delta: {getattr(event, 'delta', 'N/A')}")
