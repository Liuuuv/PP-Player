    ...
    def _return_to_search(self):
        ...
        try:
            ...
            if hasattr(self, 'thumbnail_frame') and self.thumbnail_frame.winfo_exists():
                ...
                # Si on n'a pas d'état sauvegardé avec des résultats, cacher le canvas et la scrollbar
                if not hasattr(self, 'saved_search_state') or not self.saved_search_state.get('canvas_packed', False):
