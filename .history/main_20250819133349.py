...
class MusicPlayer:
    ...
    def _update_canvas_scroll_region(self, preserve_position=True):
        ...
        return search_tab.main_playlist._update_canvas_scroll_region(self, preserve_position)
    ...
    def _find_insert_position(self, song_index):
        ...
        return search_tab.main_playlist._find_insert_position(self, song_index)
    ...
    def _add_main_playlist_item_ordered(self, filepath, song_index=None, insert_position=None):
        ...
        return search_tab.main_playlist._add_main_playlist_item_ordered(self, filepath, song_index, insert_position)
    ...
    def select_current_song_smart(self, auto_scroll=True, force_reload=False):
        ...
        return search_tab.main_playlist.select_current_song_smart(self, auto_scroll, force_reload)
    ...
    def _setup_progressive_scroll_detection(self):
        ...
        return search_tab.main_playlist._setup_progressive_scroll_detection(self)
    
    def _on_progressive_scroll(self, event=None):
        """Gère le scroll pour le chargement progressif"""
        return search_tab.main_playlist._on_progressive_scroll(self, event)
    ...
    def _is_user_looking_above_current(self, current_index):
        """Vérifie si l'utilisateur regarde au-dessus de l'index courant"""
    ...
    def _update_scroll_region_after_unload(self):
        """Met à jour la région de défilement après le déchargement d'éléments"""
        return search_tab.main_playlist._update_scroll_region_after_unload(self)
    
    def _update_canvas_scroll_region_and_restore(self, position):
        """Met à jour la région de défilement du canvas et restaure la position"""
        return search_tab.main_playlist._update_canvas_scroll_region_and_restore(self, position)
    ...
    def _check_and_unload_items(self, current_index):
        """Vérifie et décharge les éléments non visibles dans la playlist principale"""
        return search_tab.main_playlist._check_and_unload_items(self, current_index)
    
    def _invalidate_loaded_indexes_cache(self):
        """Vide le cache des indexes chargés dans la playlist principale"""
