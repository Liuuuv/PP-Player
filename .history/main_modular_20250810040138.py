...
class MusicPlayer:
    ...
    def _create_text_icon(self, text):
        return config_manager._create_text_icon(self, text)
    ...
    def _create_control_buttons(self, parent):
        return ui_controls._create_control_buttons(self, parent)
    
    def _create_library_tabs(self, parent):
        return ui_controls._create_library_tabs(self, parent)
    
    def _show_downloads_content(self):
        return ui_controls._show_downloads_content(self)
    
    def _show_playlists_content(self):
        return ui_controls._show_playlists_content(self)
    
    def _on_search_entry_change(self, event):
        return ui_controls._on_search_entry_change(self, event)
    
    def _perform_search(self):
        return ui_controls._perform_search(self)
    
    def _clear_search(self):
        return ui_controls._clear_search(self)
    
    def _on_youtube_canvas_configure(self, event):
        return ui_controls._on_youtube_canvas_configure(self, event)
    
    def _on_youtube_scroll(self, event):
        return ui_controls._on_youtube_scroll(self, event)
