...
class MusicPlayer:
    ...
    def _reset_playlist_content_state(self, tab_name=None):
        return artist_tab.core._reset_playlist_content_state(self, tab_name)
    ...
    def _show_playlist_content(self, playlist_data, target_tab="sorties"):
        ...
        return artist_tab.playlist._show_playlist_content(self, playlist_data, target_tab)
    ...
    def _display_playlist_content(self, videos, playlist_title, target_tab="sorties"):
        ...
        return artist_tab.playlist._display_playlist_content(self, videos, playlist_title, target_tab)
