...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        # Positionner la croix à droite dans le header fixe, alignée avec les onglets
        close_btn.pack(side=tk.RIGHT, padx=(5, 10), pady=(5, 5))
    ...
    def _add_artist_result(self, video, index, container):
        ...
        try:
            ...
            result_frame.columnconfigure(3, minsize=50, weight=0)  # Durée
