...
def _add_song_item(self, filepath, playlist_name, song_index, container):
    ...
    try:
        ...
        if container == self.playlist_content_container:
        ...
        number_label = tk.Label(
            item_frame,
            text=str(song_index + 1) if song_index else None,  # +1 pour commencer à 1 au lieu de 0
            bg=bg_color,
            fg='white',
        ...
        if container == self.playlist_content_container:
            ...
            print("_add_song_item, Container inconnu")
