...
class MusicPlayer:
    ...
    def _show_current_song_thumbnail_with_debug(self):
        """Fonction debug temporaire pour voir ce qui se passe"""
        print("DEBUG: _show_current_song_thumbnail_with_debug appelée")
        print(f"DEBUG: thumbnail_frame existe: {hasattr(self, 'thumbnail_frame')}")
        if hasattr(self, 'thumbnail_frame'):
            try:
                print(f"DEBUG: thumbnail_frame.winfo_exists(): {self.thumbnail_frame.winfo_exists()}")
                print(f"DEBUG: thumbnail_frame visible: {self.thumbnail_frame.winfo_viewable()}")
                # Forcer le pack de la thumbnail_frame
                self.thumbnail_frame.pack(fill='both', pady=5, padx=5, anchor="center")
                print("DEBUG: thumbnail_frame pack forcé")
            except Exception as e:
                print(f"DEBUG: Erreur avec thumbnail_frame: {e}")
        
        # Appeler la vraie fonction
        result = self._show_current_song_thumbnail()
        print("DEBUG: _show_current_song_thumbnail appelée")
        return result
    ...
    def _recreate_thumbnail_frame(self):
        ...
        try:
            ...
            self.thumbnail_frame.pack(fill='both', pady=5, padx=5, anchor="center")
            print("DEBUG: thumbnail_frame recréée avec succès")
        except Exception as e:
    ...
    def _return_to_search(self):
        ...
        try:
            ...
            print("DEBUG: _return_to_search appelant _show_current_song_thumbnail")
            self.root.after(50, lambda: self._show_current_song_thumbnail_with_debug())
