...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        # Ajouter le bouton croix à droite
        if hasattr(self, 'icons') and 'cross' in self.icons:
            close_btn = tk.Button(
                container_frame,
                image=self.icons['cross'],
                bg='#3d3d3d',
                relief='flat',
                bd=0,
