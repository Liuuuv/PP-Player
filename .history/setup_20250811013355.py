...
def setup_controls(self):
        ...
        # Time Labels au-dessus des boutons
        time_frame = ttk.Frame(button_frame)
        time_frame.grid(row=0, column=0, columnspan=7, sticky="ew", pady=(0, 5))
        ...
        self.random_button.grid(row=1, column=0, padx=3)
        ...
        self.loop_button.grid(row=1, column=1, padx=3)
        ...
        self.prev_button.grid(row=1, column=2, padx=5)
        ...
        self.play_button.grid(row=1, column=3, padx=5)
        ...
        self.next_button.grid(row=1, column=4, padx=5)
        ...
        self.hey_button.grid(row=1, column=5, padx=3)
        ...
        self.add_button.grid(row=1, column=6, padx=3)
