...
class MusicPlayer:
    ...
    def hide_queue_indicator(self, queue_indicator):
        """Cache l'indicateur de queue"""
        return tools.hide_queue_indicator(self, queue_indicator)

    def show_queue_indicator(self, queue_indicator):
        """Affiche l'indicateur de queue"""
        return tools.show_queue_indicator(self, queue_indicator)
