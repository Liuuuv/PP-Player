...
class MusicPlayer:
    ...
    def on_tab_changed(self, event):
        ...
        if selected_tab == "Recherche":
            # CORRECTION: Forcer l'affichage de la playlist quand on va sur l'onglet Recherche
            print("🔄 DEBUG: Onglet Recherche sélectionné, vérification de l'affichage de la playlist")
            if hasattr(self, '_display_main_playlist') and hasattr(self, 'main_playlist') and len(self.main_playlist) > 0:
                # Différer légèrement pour laisser l'onglet se charger
                self.safe_after(100, lambda: self._display_main_playlist())
                print(f"📊 DEBUG: Programmation de l'affichage de {len(self.main_playlist)} éléments")
            else:
                print("⚠️ DEBUG: Pas de playlist à afficher ou fonction manquante")
    ...
    def _setup_infinite_scroll(self):
        ...
        return search_tab.main_playlist._setup_infinite_scroll(self)
    ...
    def _check_infinite_scroll(self):
        ...
        return search_tab.main_playlist._check_infinite_scroll(self)
    ...
    def _load_more_songs_below(self):
        ...
        return search_tab.main_playlist._load_more_songs_below(self)
    ...
    def _adjust_canvas_scroll_position(self, start_index, end_index, center_index):
        ...
        return search_tab.main_playlist._adjust_canvas_scroll_position(self, start_index, end_index, center_index)

    def _restore_normal_scroll(self):
        """Restaure le scroll normal de Tkinter"""
        return search_tab.main_playlist._restore_normal_scroll(self)

    def _display_main_playlist(self):
        """Affiche la main playlist avec optimisation windowing si nécessaire"""
        return search_tab.main_playlist._display_main_playlist(self)

    def _display_full_playlist(self):
        """Affiche tous les éléments de la playlist (mode complet)"""
        return search_tab.main_playlist._display_full_playlist(self)

    def _display_full_playlist_original(self):
        """Affiche tous les éléments de la playlist (mode complet original)"""
        return search_tab.main_playlist._display_full_playlist_original(self)

    def _display_windowed_playlist_original(self):
        """Affiche la playlist avec windowing original (10 avant + 10 après)"""
        return search_tab.main_playlist._display_windowed_playlist_original(self)

    def _add_simple_indicator(self, text, direction, target_index):
        """Ajoute un indicateur simple de navigation"""
        return search_tab.main_playlist._add_simple_indicator(self, text, direction, target_index)

    def _update_scroll_region_simple(self):
        """Met à jour la région de scroll de manière simple"""
        return search_tab.main_playlist._update_scroll_region_simple(self)

    def _display_windowed_playlist(self):
        """Affiche la playlist avec le système de windowing optimisé"""
        return search_tab.main_playlist._display_windowed_playlist(self)

    def _calculate_window_bounds(self, center_index):
        """Calcule les bornes de la fenêtre d'affichage"""
        return search_tab.main_playlist._calculate_window_bounds(self, center_index)

    def _calculate_smart_window_bounds(self, view_center):
        """Calcule les bornes intelligentes pour éviter les interruptions"""
        return search_tab.main_playlist._calculate_smart_window_bounds(self, view_center)

    def _add_window_indicators(self, start_index, end_index):
        """Ajoute les indicateurs de navigation"""
        return search_tab.main_playlist._add_window_indicators(self, start_index, end_index)
    ...
    def _add_smart_window_indicators(self, start_index, end_index, view_center):
        ...
        return search_tab.main_playlist._add_smart_window_indicators(self, start_index, end_index, view_center)

    def _add_navigation_indicator(self, text, direction, target_index):
        """Ajoute un indicateur de navigation cliquable"""
        return search_tab.main_playlist._add_navigation_indicator(self, text, direction, target_index)
    ...
    def _add_smart_navigation_indicator(self, text, direction, target_index, current_view_center):
        ...
        return search_tab.main_playlist._add_smart_navigation_indicator(self, text, direction, target_index, current_view_center)

    def _update_scroll_region_manual(self):
        """Met à jour la région de scroll manuellement"""
        return search_tab.main_playlist._update_scroll_region_manual(self)

    def _update_scroll_region_windowed(self, start_index, end_index):
        """Met à jour la région de scroll pour le mode windowed"""
        return search_tab.main_playlist._update_scroll_region_windowed(self, start_index, end_index)
    ...
    def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None, is_current_playing=False):
        ...
        return search_tab.main_playlist._add_main_playlist_item(self, filepath, thumbnail_path, song_index, is_current_playing)
