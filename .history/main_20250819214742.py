...
class MusicPlayer:
    def __init__(self, root):
        ...
        # Variables pour le chargement virtuel (valeurs par défaut)
        self.virtual_initial_load_count = 20  # Nombre de musiques chargées initialement
        self.virtual_scroll_load_count = 10   # Nombre de musiques déchargées/chargées lors du scroll
    ...
    def _setup_virtual_scroll(self):
        return library_tab.downloads._setup_virtual_scroll(self)

    def _bind_virtual_mousewheel(self, widget, canvas):
        return library_tab.downloads._bind_virtual_mousewheel(self, widget, canvas)
    
    def _load_virtual_window(self):
        return library_tab.downloads._load_virtual_window(self)

    def _update_virtual_scrollbar(self):
        return library_tab.downloads._update_virtual_scrollbar(self)

    def _handle_virtual_scroll(self, event):
        return library_tab.downloads._handle_virtual_scroll(self, event)
