...
class CustomVolumeSlider(tk.Frame):
    ...
    def __init__(self, parent, from_=0, to=100, value=50, command=None, orient='horizontal', 
        ...
        # Permettre le scroll de la molette de passer à travers
        self.canvas.bind('<MouseWheel>', self._propagate_scroll)
        self.canvas.bind('<Button-4>', self._propagate_scroll)  # Linux
        self.canvas.bind('<Button-5>', self._propagate_scroll)  # Linux
