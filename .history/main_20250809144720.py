...
class MusicPlayer:
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            item_frame.bind("<Double-1>", lambda e, i=item_frame: self.select_item(i))
            thumbnail_label.bind("<Double-1>", lambda e, i=item_frame: self.select_item(i))
            title_label.bind("<Double-1>", lambda e, i=item_frame: self.select_item(i))
    ...
    def select_playlist_item(self,item_frame):
        # Désélectionner tous les autres éléments
        for child in self.playlist_container.winfo_children():
            if hasattr(child, 'selected'):
                child.selected = False
        ...
        self._play_playlist_item(item_frame.file_path)
    ...
    def play_track(self):
        try:
            ...
            # self.select_playlist_item(self,item_frame)
