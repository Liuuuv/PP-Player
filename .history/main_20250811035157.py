...
class MusicPlayer:
    def __init__(self, root):
        ...
        self.max_search_results = MAX_SEARCH_RESULTS  # Réduire le nombre maximum de résultats
        ...
        self.search_delay = SEARCH_DELAY  # Délai en millisecondes avant de lancer la recherche
        self.normalized_filenames = {}  # Cache des noms de fichiers normalisés
        self.fast_display_mode = FAST_DISPLAY_MODE  # Mode d'affichage rapide pour éviter les saccades

        # Variables pour limiter les threads de miniatures
        self.thumbnail_threads = 0  # Compteur de threads de miniatures actifs
        self.max_thumbnail_threads = MAX_THUMBNAIL_THREADS  # Réduire à 2 threads pour éviter les saccades
    ...
    def _perform_complete_search(self, query):
        ...
        try:
            ...
            with YoutubeDL(search_opts) as ydl:
                ...
                results = ydl.extract_info(f"ytsearch{MAX_SEARCH_RESULTS}:{query}", download=False)
