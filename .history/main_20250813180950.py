...
class MusicPlayer:
    ...
    def _show_playlist_back_button(self):
        ...
        try:
            if hasattr(self, 'playlist_back_btn') and self.artist_tab_back_btn and self.artist_tab_back_btn.winfo_exists():
                self.artist_tab_back_btn.place(in_=self.artist_tab_back_btn.master, relx=1.0, rely=0.0, anchor="ne", x=-40, y=5)
                self.artist_tab_back_btn.tkraise()
        except Exception as e:
