...
class MusicPlayer:
    ...
    def _show_artist_content(self, artist_name, video_data):
        ...
        try:
            ...
            # Vider les résultats actuels et afficher la zone YouTube
            self._clear_search_results()
            self._show_youtube_results()
            
            # Créer l'interface artiste dans la zone YouTube existante
            self._create_artist_header()
