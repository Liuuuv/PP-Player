    ...
    def _perform_complete_search(self, query):
        ...
        try:
            ...
            with YoutubeDL(search_opts) as ydl:
                ...
                if self.youtube_music_selected.get():
                    # Recherche sur YouTube Music - utiliser une recherche YouTube normale
                    # mais avec des mots-clés pour privilégier la musique
                    music_query = f"{query} music audio song"
                    search_query = f"ytsearch50:{music_query}"
                else:
