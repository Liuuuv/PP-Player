...
class TestDragDrop:
    def __init__(self):
        ...
        self.test_frame.bind("<Button-1>", on_click)
        self.test_frame.bind("<Button-3>", on_click)
        self.test_label.bind("<Button-1>", on_click)
        self.test_label.bind("<Button-3>", on_click)
