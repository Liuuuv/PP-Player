...
SEARCH_WAIT_TIME_BETWEEN_RESULTS = 20  # en millisecondes - optimisé pour la vitesse
...
# Durée maximale (en secondes) pour afficher les résultats de recherche YouTube
MAX_DURATION_SHOW_SEARCH = 600  # 10 minutes

ARTIST_TAB_MAX_WIDTH_ARTIST_NAME = 90  # Largeur maximale en pixels pour le nom de l'artiste dans l'onglet Artiste