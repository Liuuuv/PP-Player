    ...
    def download_thread():
        ...
        try:
            ...
            if existing_file:
                ...
                app.root.after(0, lambda: app._add_downloaded_file(existing_file, thumbnail_path, title, url, add_to_playlist))
                app.root.after(0, lambda: app.status_bar.config(text=f"Fichier existant trouvé: {title}"))
            ...
            app.root.after(0, lambda: setattr(app, '_temp_download_result',
                app.add_download_to_tab(url, title_, video_data_)))
