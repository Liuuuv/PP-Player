...
class DragDropHandler:
    ...
    def _add_to_queue(self, file_path):
        ...
        # Si c'est la musique en cours de lecture, ne pas créer de duplicata
        # Sinon, ajouter même si déjà présent pour créer un duplicata
        if is_currently_playing:
            # Si c'est la musique en cours, ne l'ajouter que si elle n'est pas déjà présente
            if file_path not in self.music_player.main_playlist:
                self.music_player.main_playlist.append(file_path)
        else:
            # Si ce n'est pas la musique en cours, toujours ajouter (même en duplicata)
            self.music_player.main_playlist.append(file_path)
