...
class MusicPlayer:
    def __init__(self, root):
        ...
        self.preview_was_paused = False  # État de pause avant la prévisualisation
        self.preview_current_index = None  # Index de la chanson avant prévisualisation
        self.preview_current_time = 0  # Position avant prévisualisation
        self.preview_timer = None  # Timer pour arrêter la prévisualisation automatiquement
