...
class DragDropHandler:
    ...
    def _on_drag_motion(self, event, frame):
        ...
        if not frame.drag_enabled:
            print(f"🔴 DRAG MOTION IGNORÉ: drag_enabled=False sur {event.widget.__class__.__name__}")
            return
        
        print(f"🔵 DRAG MOTION OK: drag_enabled=True sur {event.widget.__class__.__name__}")
