...
def setup_controls(self):
        ...
        # Time Labels sur les bords absolus de la fenêtre (à la même hauteur que les volumes)
        self.current_time_label = ttk.Label(buttons_volume_frame, text="00:00")
        self.current_time_label.grid(row=0, column=0, sticky="w", padx=(10, 0), pady=(0, 5))
        
        self.song_length_label = ttk.Label(buttons_volume_frame, text="00:00")
        self.song_length_label.grid(row=0, column=2, sticky="e", padx=(0, 10), pady=(0, 5))

        # Frame volume offset à gauche (largeur fixe)
        volume_offset_frame = ttk.Frame(buttons_volume_frame, width=180)
        volume_offset_frame.grid(row=1, column=0, sticky="w")
        ...
        volume_frame.grid(row=1, column=2, sticky="e")
