...
class MusicPlayer:
    ...
    def _add_playlist_item(self, filepath, thumbnail_path=None):
        ...
        try:
            ...
            delete_btn.grid(row=0, column=2, sticky='w', padx=1, ipadx=3, ipady=3)
            
            delete_btn.bind("<Double-1>", lambda f=filepath, frame=item_frame: self._remove_playlist_item(f, frame))
