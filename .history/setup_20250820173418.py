...
def create_ui(self):
    ...
    self.output_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-185, y=-5)
    ...
    self.errors_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-155, y=-5)
    ...
    # Positionner le bouton à droite du bouton output
    self.settings_button.place(in_=self.notebook, relx=1.0, rely=0.0, anchor="ne", x=-5, y=-5)
    create_tooltip(self.errors_button, "Erreurs système\nAffiche les erreurs détectées dans l'application")
...
def setup_search_tab(self):
    ...
    self.playlist_container = ttk.Frame(self.main_playlist_canvas)
    self.main_playlist_canvas.create_window((0, 0), window=self.playlist_container, anchor="nw")
    ...
    self._bind_mousewheel(self.playlist_container, self.main_playlist_canvas)
    
    # import search_tab.main_playlist
    # self._bind_mousewheel(self.main_playlist_canvas, self.main_playlist_canvas, func=search_tab.main_playlist.forward_wheel)
    # self._bind_mousewheel(self.playlist_container, self.main_playlist_canvas, func=search_tab.main_playlist.forward_wheel)
