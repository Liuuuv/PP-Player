...
/*************  ✨ Windsurf Command ⭐  *************/
    """
    Configure le contenu de l'onglet "Rechercher" :

        * Un champ de saisie pour la recherche YouTube
        * Un bouton pour lancer la recherche
        * Un bouton pour effacer la recherche
        * Un canvas avec scrollbar pour la playlist principale
        * Un canvas avec scrollbar pour les résultats de la recherche YouTube

    La playlist principale est collée à gauche, les résultats de la recherche sont à droite
    et peuvent se déployer ou se replier en fonction de la taille de la fenêtre.
    """

/*******  09b4d1a2-e2f3-464d-b60e-8590c60acd11  *******/
