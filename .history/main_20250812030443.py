...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        print(f"DEBUG: Notebook créé et empaqueté dans {self.results_container}")
        ...
        print(f"DEBUG: Onglets créés - Musiques: {self.musiques_frame}, Sorties: {self.sorties_frame}")
