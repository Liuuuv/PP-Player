...
class DragDropHandler:
    ...
    def _end_visual_drag(self, frame):
        ...
        # Remettre la couleur normale, mais vérifier si c'est l'élément sélectionné
        if hasattr(frame, 'selected') and frame.selected:
            # Si c'est l'élément sélectionné, utiliser la couleur de sélection
            self._set_frame_colors(frame, '#5a9fd8')  # Couleur bleue de sélection
        else:
            # Sinon, remettre la couleur normale
