...
class ArtistTabManager:
        ...
        try:
            ...
            if current_tab_id:
                ...
                if current_tab_text == "Sorties":
                    ...
                    print(f"DEBUG: Onglet Sorties - artist_tab_active_sorties = {self.player.artist_tab_active_sorties}")
                    ...
                    print(f"DEBUG: Onglet Playlists - artist_tab_active_playlists = {self.player.artist_tab_active_playlists}")
    ...
    def _update_back_button_visibility(self, current_tab_text):
        ...
        try:
            ...
            print(f"DEBUG: _update_back_button_visibility - onglet='{current_tab_text}', should_show={should_show}")
            
            if should_show:
                print("DEBUG: Affichage du bouton retour")
                self._show_playlist_back_button()
            else:
                print("DEBUG: Masquage du bouton retour")
    ...
    def _show_playlist_back_button(self):
        ...
        try:
            ...
            print(f"DEBUG: _show_playlist_back_button - button_exists={button_exists}")
            
            if button_exists:
                # Le bouton existe, juste le repositionner
                print("DEBUG: Repositionnement du bouton existant")
                ...
                print("DEBUG: Création d'un nouveau bouton")
