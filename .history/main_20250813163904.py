...
class MusicPlayer:
    ...
    def _update_back_buttons_visibility(self, current_tab_text):
        ...
        try:
            # Masquer tous les boutons retour d'abord
            self._hide_playlist_back_button_for_tab("sorties")
            self._hide_playlist_back_button_for_tab("playlists")
            
            # Afficher uniquement le bouton de l'onglet actuel si nécessaire
        ...
        if hasattr(self, 'artist_notebook') and self.artist_notebook.winfo_exists():
            try:
                ...
                if current_tab_id:
                    ...
                    # Mettre à jour la visibilité des boutons selon l'onglet actuel
                    self._update_back_buttons_visibility(current_tab_text)
            except:
                pass
