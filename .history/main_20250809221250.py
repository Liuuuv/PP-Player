...
class MusicPlayer:
    ...
    def setup_search_tab(self):
        ...
        self.thumbnail_frame = tk.Frame(
            ...
            bg='#3d3d3d',
            height=30  # Limiter la hauteur pour éviter que les contrôles disparaissent
        )
        # Afficher la frame thumbnail par défaut
        self.thumbnail_frame.pack(fill=tk.BOTH, expand=True, pady=100, side="top")
        # self.thumbnail_frame.pack(fill=tk.X, pady=2)
        # self.thumbnail_frame.pack_propagate(False)  # Empêcher le redimensionnement automatique
