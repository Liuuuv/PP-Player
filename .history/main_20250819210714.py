...
class MusicPlayer:
    ...
    def _bind_mousewheel(self, widget, canvas, func=None):
        ...
        widget.bind("<Enter>", lambda e: self._bind_scroll(canvas, func=None))
        widget.bind("<Leave>", lambda e: self._unbind_scroll(canvas, func=None))
    ...
    def _bind_scroll(self, canvas, func=None):
        ...
        if func is None:
            ...
            canvas.bind_all("<MouseWheel>", lambda e: func(e, canvas))
            canvas.bind_all("<Button-4>", lambda e: func(e, canvas))
            canvas.bind_all("<Button-5>", lambda e: self._on_mousewheel(e, canvas))
