...
# Robustly resolve '__init__' in frozen builds (PyInstaller)
...
if '__init__' not in sys.modules:
    try:
        ...
        if os.path.exists(_init_path):
            _spec = importlib.util.spec_from_file_location('__init__', _init_path)
            _mod = importlib.util.module_from_spec(_spec)
            _spec.loader.exec_module(_mod)
            sys.modules['__init__'] = _mod
...
class MusicPlayer:
    ...
    def init(self):
        ...
        self.current_version = "1.0.0"  # Version actuelle de l'app
    ...
    def _load_large_thumbnail(self, filepath, label):
        ...
        return tools._load_large_thumbnail(self, filepath, label)
