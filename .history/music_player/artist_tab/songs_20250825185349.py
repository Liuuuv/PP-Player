...
def _search_artist_videos_with_id(self):
        ...
        try:
            ...
            # Utiliser la configuration optimisée centralisée
            from artist_tab.config import get_optimized_search_options
            search_opts = get_optimized_search_options("videos")
