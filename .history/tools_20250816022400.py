...
def _add_song_item(self, filepath_or_video, container, playlist_name=None, song_index=None, item_type="downloads", video_index=None):
    ...
    try:
        ...
        metadata_frame.columnconfigure(1, weight=1)  # Séparateur
        metadata_frame.columnconfigure(2, weight=2)  # Album
        metadata_frame.columnconfigure(3, weight=2)  # Séparateur
        metadata_frame.columnconfigure(4, weight=2)  # Date
        ...
        artist_label.grid(row=0, column=3, sticky='w')
