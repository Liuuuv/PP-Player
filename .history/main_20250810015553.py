...
class MusicPlayer:
    ...
    def setup_controls(self):
        ...
        self.loop_button = tk.Button(
            ...
            bg="#3d3d3d" if not self.loop_mode else "#4a8fe7",
            fg="white",
            activebackground="#4a4a4a",
            relief="flat",
            bd=0,
    ...
    def _add_download_item(self, filepath):
        ...
        try:
            ...
            # Double-clic pour jouer directement ou supprimer avec Ctrl
    ...
    def next_track(self):
        ...
        # Si on est à la dernière chanson et que le mode loop n'est pas activé
        if self.current_index >= len(self.main_playlist) - 1 and not self.loop_mode:
            # Arrêter la lecture
            pygame.mixer.music.stop()
            self.status_bar.config(text="Fin de la playlist")
            return
        
        # Passer à la chanson suivante (avec boucle si mode loop activé)
        self.current_index = (self.current_index + 1) % len(self.main_playlist)
        self.play_track()
    ...
    def toggle_loop_mode(self):
        ...
        if self.loop_mode:
            ...
            self.status_bar.config(text="Mode boucle activé")
        else:
