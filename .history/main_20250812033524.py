                    ...
                    if hasattr(self, 'current_artist_channel_url') and self.current_artist_channel_url:
                        try:
                            ...
                            if channel_info and 'entries' in channel_info:
                                ...
                                # Garder toutes les playlists valides sans filtre strict
                                playlists = [p for p in playlists if p and p.get('id')]
                                all_playlists.extend(playlists[:20])  # Prendre les 20 premières
                        except Exception as e:
