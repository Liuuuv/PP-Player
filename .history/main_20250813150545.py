...
class MusicPlayer:
    ...
    def _create_artist_tabs(self):
        ...
        # Messages de chargement avec boutons d'annulation
        # Onglet Musiques
        musiques_container = tk.Frame(self.musiques_frame, bg='#3d3d3d')
        musiques_container.pack(expand=True, fill='both')
        ...
        musiques_cancel_btn = tk.Button(
            ...
            relief='raised',
            bd=1,
            command=self._cancel_artist_search,
            cursor='hand2',
            takefocus=0
        )
        musiques_cancel_btn.pack(pady=5)
        
        # Onglet Sorties
        sorties_container = tk.Frame(self.sorties_frame, bg='#3d3d3d')
        sorties_container.pack(expand=True, fill='both')
        ...
        sorties_cancel_btn.pack(pady=5)
        
        # Onglet Playlists
        playlists_container = tk.Frame(self.playlists_frame, bg='#3d3d3d')
        playlists_container.pack(expand=True, fill='both')
        ...
        playlists_cancel_btn = tk.Button(
            playlists_container,
            text="Annuler",
            bg='#555555',
            fg='white',
        ...
        playlists_cancel_btn.pack(pady=5)
