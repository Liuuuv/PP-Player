...
class MusicPlayer:
    ...
    def _add_main_playlist_item(self, filepath, thumbnail_path=None, song_index=None):
        ...
        try:
            ...
            delete_btn.bind("<Double-1>", lambda event, f=filepath, frame=item_frame: self._remove_main_playlist_item(f, frame, event))
    ...
    def _remove_main_playlist_item(self, filepath, frame, event=None):
