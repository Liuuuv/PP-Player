            ...
            try:
                ...
                with YoutubeDL(search_opts) as ydl:
                    ...
                    if channel_id:
                        ...
                        # Sortir de la fonction si on ne trouve pas l'ID
                        self.root.after(0, lambda: self.status_bar.config(text="Impossible de trouver l'ID de la chaîne"))
                        return
                    
                    # Utiliser uniquement l'ID de chaîne trouvé
                    if channel_urls_to_try:
                        url = channel_urls_to_try[0]  # Une seule URL maintenant
                        try:
                            print(f"Extraction des vidéos depuis: {url}")
