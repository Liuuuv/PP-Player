...
class MusicPlayer:
    ...
    def _add_playlist_song_item(self, filepath, playlist_name, song_index):
        ...
        return tools._add_song_item(self, filepath, playlist_name, self.playlist_content_container, song_index=song_index)
    ...
    def _start_thumbnail_loading(self, files_to_display, container):
        ...
        return library_tab.downloads._start_thumbnail_loading(self, files_to_display, container)
