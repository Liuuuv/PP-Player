...
class MusicPlayer:
    ...
    def _animate_title_step(self):
        ...
        pause_cycles = 30  # Nombre de cycles à attendre entre les défilements (environ 2 secondes à 60fps)
        ...
        if self.title_scroll_position >= len(self.title_full_text):
            self.title_scroll_position = 0
    ...
    def _get_scrolled_title_text(self, full_text, scroll_pos, max_width_pixels):
        ...
        # On ajoute des espaces pour créer une transition fluide
