        ...
        def on_artist_click(event):
            try:
                ...
                if artist:
                    ...
                    try:
                        ...
                        if youtube_metadata:
                            ...
                            if channel_url:
                                ...
                                print(f"DEBUG: URL chaîne trouvée: {channel_url}")
                    except Exception as e:
                        print(f"DEBUG: Erreur métadonnées YouTube: {e}")
                    
                    # Si pas d'URL trouvée, utiliser le fallback
                    if 'channel_url' not in video_data:
                        print("DEBUG: Utilisation fallback URL")
                        import urllib.parse
                    ...
                    print("DEBUG: Avant appel _show_artist_content")
                    self._show_artist_content(artist, video_data)
                    print("DEBUG: Après appel _show_artist_content")
            except Exception as e:
                print(f"DEBUG: Erreur dans on_artist_click: {e}")
                import traceback
                traceback.print_exc()
