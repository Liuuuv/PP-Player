...
class MusicPlayer:
    ...
    def _refresh_playlist_display(self):
        ...
        print(f"🔄 DEBUG REFRESH: _refresh_playlist_display appelé")
        ...
        if current_time - self._last_refresh_time < 0.1:  # 100ms de protection
            print(f"🔄 DEBUG REFRESH: Protection anti-spam activée, retour")
            return
        ...
        try:
            ...
            if not hasattr(self, 'playlist_container'):
                print(f"❌ DEBUG REFRESH: playlist_container n'existe pas")
                return
                
            if not self.playlist_container.winfo_exists():
                print(f"❌ DEBUG REFRESH: playlist_container détruit")
                return
            
            print(f"✅ DEBUG REFRESH: playlist_container OK, {len(self.main_playlist)} chansons à afficher")
