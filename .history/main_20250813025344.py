...
class MusicPlayer:
    ...
    def _reset_frame_appearance(self, frame, bg_color, error=False):
        ...
        try:
            if frame.winfo_exists():
                ...
                # Appliquer la couleur à tous les widgets
                widgets_to_update = ['title_label', 'duration_label', 'thumbnail_label', 'text_frame']
    ...
    def _add_artist_result(self, video, index, container):
        ...
        try:
            ...
            # Effet hover
            def on_enter(event):
                # Vérifier si le frame est en cours de téléchargement
                if hasattr(result_frame, 'is_downloading') and result_frame.is_downloading:
            ...
            # Bindings pour l'effet hover (tous les widgets)
            for widget in [result_frame, text_frame, title_label, thumbnail_label, duration_label]:
