...
class MusicPlayer:
    ...
    def _create_artist_header(self):
        """Crée un header simple pour l'artiste dans la zone YouTube"""
        # Créer un header dans le results_container
        header_frame = tk.Frame(self.results_container, bg='#3d3d3d', height=50)
        ...
        artist_title = tk.Label(
            header_frame,
            text=f"Vidéos de : {self.current_artist_name}",
            bg='#3d3d3d',
            fg='white',
            font=('TkDefaultFont', 12, 'bold')
        )
        artist_title.pack(expand=True, pady=10)
        ...
        self.artist_loading_label = loading_label
