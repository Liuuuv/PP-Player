...
def show_selection_menu(self, event):
    ...
    if has_youtube_videos:
        # Pour les vidéos YouTube, télécharger et ajouter à la liste de lecture
        context_menu.add_command(
...
def _download_and_add_to_playlists(self, video_url, playlist_names):
        ...
        try:
            ...
            if existing_file:
                ...
                # Afficher un message de confirmation
                self.root.after(0, lambda: self.status_bar.config(text=f"Fichier existant ajouté aux playlists: {title}"))
